...
_openssl_to_ssl_minimum_version: dict[int, int] = {
    ...
    ssl.TLSVersion.TLSv1_2: _OP_NO_SSLv2_OR_SSLv3
    | _OP_NO_TLSv1
    | _OP_NO_TLSv1_1,
...
_openssl_to_ssl_maximum_version: dict[int, int] = {
    ...
    ssl.TLSVersion.TLSv1_1: _OP_NO_SSLv2_OR_SSLv3
    | _OP_NO_TLSv1_2
    | _OP_NO_TLSv1_3,
...
class PyOpenSSLContext:
    ...
    def load_verify_locations(
        ...
        try:
            ...
            raise ssl.SSLError(
                f'unable to load trusted certificates: {e!r}'
            ) from e
    ...
    def load_cert_chain(
        ...
        try:
            ...
            raise ssl.SSLError(
                f'Unable to load certificate chain: {e!r}'
            ) from e
