...
class Extension:
    ...
    def parse(
        self, parser: 'Parser'
    ) -> t.Union[nodes.Node, t.List[nodes.Node]]:
...
class InternationalizationExtension(Extension):
    ...
    def _extract(
        ...
        t.Tuple[
            int, str, t.Union[t.Optional[str], t.Tuple[t.Optional[str], ...]]
        ]
    ]:
    ...
    def _make_node(
        ...
        node = nodes.Call(
            nodes.Name(func_name, 'load'), func_args, [], None, None
        )
...
class _CommentFinder:
    ...
    def __init__(
        self,
        tokens: t.Sequence[t.Tuple[int, str, str]],
...
def babel_extract(
    ...
    t.Tuple[
        int,
        str,
        t.Union[t.Optional[str], t.Tuple[t.Optional[str], ...]],
        t.List[str],
    ]
]:
    ...
    environment = Environment(
        ...
        getbool(
            options, 'keep_trailing_newline', defaults.KEEP_TRAILING_NEWLINE
        ),
        tuple(extensions),
        cache_size=0,
        auto_reload=False,
