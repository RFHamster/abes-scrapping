...
class HeadersParser:
    ...
    def parse_headers(
        ...
        while line:
            ...
            continuation = (
                self._lax and line and line[0] in (32, 9)
            )  # (' ', '\t')
            ...
            if self._payload_parser is None and not self._upgraded:
                ...
                if pos >= start_pos:
                    ...
                    if self._lines[-1] == EMPTY:
                        ...
                        # calculate payload
                        empty_body = status_code_must_be_empty_body(
                            code
                        ) or bool(method and method_must_be_empty_body(method))
            ...
            # feed payload
                ...
                try:
                    ...
                    if self.payload_exception is not None:
                        reraised_exc = self.payload_exception(
                            str(underlying_exc)
                        )
    ...
    def parse_message(self, lines: List[bytes]) -> RawResponseMessage:
        ...
        if close is None:
            ...
            # https://www.rfc-editor.org/rfc/rfc9112.html#name-message-body-length
                ...
                or hdrs.TRANSFER_ENCODING in headers
            ):
                close = False
            else:
