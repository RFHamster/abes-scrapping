...
ACCESS_CONTROL_ALLOW_CREDENTIALS: Final[istr] = istr(
    'Access-Control-Allow-Credentials'
)
ACCESS_CONTROL_ALLOW_HEADERS: Final[istr] = istr(
    'Access-Control-Allow-Headers'
)
ACCESS_CONTROL_ALLOW_METHODS: Final[istr] = istr(
    'Access-Control-Allow-Methods'
)
ACCESS_CONTROL_ALLOW_ORIGIN: Final[istr] = istr('Access-Control-Allow-Origin')
ACCESS_CONTROL_EXPOSE_HEADERS: Final[istr] = istr(
    'Access-Control-Expose-Headers'
)
ACCESS_CONTROL_REQUEST_HEADERS: Final[istr] = istr(
    'Access-Control-Request-Headers'
)
ACCESS_CONTROL_REQUEST_METHOD: Final[istr] = istr(
