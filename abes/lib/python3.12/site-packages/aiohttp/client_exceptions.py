...
class ClientConnectorError(ClientOSError):
    ...
    def __init__(
        self, connection_key: ConnectionKey, os_error: OSError
    ) -> None:
...
class ServerDisconnectedError(ServerConnectionError):
    ...
    def __init__(
        self, message: Union[RawResponseMessage, str, None] = None
    ) -> None:
        if message is None:
...
class ServerFingerprintMismatch(ServerConnectionError):
    ...
    def __init__(
        self, expected: bytes, got: bytes, host: str, port: int
    ) -> None:
...
class InvalidURL(ClientError, ValueError):
    ...
    def __init__(
        self, url: StrOrURL, description: Union[str, None] = None
    ) -> None:
...
class InvalidUrlRedirectClientError(
    InvalidUrlClientError, RedirectClientError
):
    """Invalid URL redirect client error."""


class NonHttpUrlRedirectClientError(
    NonHttpUrlClientError, RedirectClientError
):
