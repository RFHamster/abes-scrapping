    ...
    def __init__(
        ...
        *,
        ...
        self._cookies: DefaultDict[
            Tuple[str, str], SimpleCookie
        ] = defaultdict(SimpleCookie)
        self._morsel_cache: DefaultDict[
            Tuple[str, str], Dict[str, Morsel[str]]
        ] = defaultdict(dict)
        ...
        for p in pairs:
            for name, cookie in self._cookies[p].items():
                ...
                if (
                    domain,
                    name,
                ) in self._host_only_cookies and domain != hostname:
                    continue
