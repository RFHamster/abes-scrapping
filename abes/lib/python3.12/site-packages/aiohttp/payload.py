...
class IOBasePayload(Payload):
    ...
    def decode(self, encoding: str = 'utf-8', errors: str = 'strict') -> str:
        return ''.join(
            r.decode(encoding, errors) for r in self._value.readlines()
        )
...
class AsyncIterablePayload(Payload):
    ...
    def __init__(
        self, value: _AsyncIterable, *args: Any, **kwargs: Any
    ) -> None:
...
PAYLOAD_REGISTRY.register(
    AsyncIterablePayload, AsyncIterable, order=Order.try_last
)
