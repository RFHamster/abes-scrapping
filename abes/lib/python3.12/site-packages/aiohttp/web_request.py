...
class BaseRequest(MutableMapping[str, Any], HeadersMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._post: Optional[
            MultiDictProxy[Union[str, bytes, FileField]]
        ] = None
    ...
    def message(self) -> RawRequestMessage:
        warnings.warn(
            'Request.message is deprecated', DeprecationWarning, stacklevel=3
        )
    ...
    def loop(self) -> asyncio.AbstractEventLoop:
        warnings.warn(
            'request.loop property is deprecated',
            DeprecationWarning,
            stacklevel=2,
        )
        return self._loop
    ...
    def url(self) -> URL:
        ...
        return URL.build(scheme=self.scheme, authority=self.host).join(
            self._rel_url
        )
    ...
    def if_none_match(self) -> Optional[Tuple[ETag, ...]]:
        ...
        This header is represented as a `tuple` of `ETag` objects.
        """
        return self._if_match_or_none_impl(
            self.headers.get(hdrs.IF_NONE_MATCH)
        )
