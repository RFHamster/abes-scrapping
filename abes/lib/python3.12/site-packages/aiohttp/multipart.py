...
class BodyPartReader:
    ...
    def __init__(
        ...
        *,
        ...
        length = (
            ...
            else self.headers.get(CONTENT_LENGTH, None)
        )
    ...
    async def form(
        ...
        try:
            ...
            raise ValueError(
                'data cannot be decoded with %s encoding' % real_encoding
            )
    ...
    def get_charset(self, default: str) -> str:
        ...
        return mimetype.parameters.get(
            'charset', self._default_charset or default
        )
...
class BodyPartReaderPayload(Payload):
    ...
    def __init__(
        self, value: BodyPartReader, *args: Any, **kwargs: Any
    ) -> None:
...
class MultipartReader:
    ...
    def __init__(
        self, headers: Mapping[str, str], content: StreamReader
    ) -> None:
        self._mimetype = parse_mimetype(headers[CONTENT_TYPE])
        assert (
            self._mimetype.type == 'multipart'
    ...
    def _get_boundary(self) -> str:
        ...
        if len(boundary) > 70:
            raise ValueError(
                'boundary %r is too long (70 chars max)' % boundary
            )
    ...
    async def _read_boundary(self) -> None:
        ...
        if chunk == self._boundary:
            ...
            raise ValueError(
                f'Invalid boundary {chunk!r}, expected {self._boundary!r}'
            )
...
class MultipartWriter(Payload):
    ...
    def __init__(
        self, subtype: str = 'mixed', boundary: Optional[str] = None
    ) -> None:
        ...
        if self._encoding == 'base64':
            if self._encoding_buffer:
                await self._writer.write(
                    base64.b64encode(self._encoding_buffer)
                )
