...
class ServerErrorMiddleware:
    ...
    def __init__(
        self,
        app: ASGIApp,
        handler: typing.Callable[[Request, Exception], typing.Any]
        | None = None,
        debug: bool = False,
    ) -> None:
        self.app = app
    ...
    def generate_html(self, exc: Exception, limit: int = 7) -> str:
        ...
        error = (
            f'{html.escape(exc_type_str)}: {html.escape(str(traceback_obj))}'
        )

        return TEMPLATE.format(
            styles=STYLES, js=JS, error=error, exc_html=exc_html
        )
