        ...
        if args:
            if isinstance(
                ...
                status_code = (
                    args[2]
                    if len(args) > 2
                    else kwargs.get('status_code', 200)
                )
                headers = args[2] if len(args) > 2 else kwargs.get('headers')
                media_type = (
                    args[3] if len(args) > 3 else kwargs.get('media_type')
                )
                background = (
                    args[4] if len(args) > 4 else kwargs.get('background')
                )
                ...
                media_type = (
                    args[5] if len(args) > 5 else kwargs.get('media_type')
                )
                background = (
                    args[6] if len(args) > 6 else kwargs.get('background')
                )
