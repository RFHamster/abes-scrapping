...
class MixedAnnotatedAndDefaultStyleError(Exception):
    ...
    def __str__(self) -> str:
        annotated_param_type_str = _param_type_to_user_string(
            self.annotated_param_type
        )
        default_param_type_str = _param_type_to_user_string(
            self.default_param_type
        )
...
def get_params_from_function(func: Callable[..., Any]) -> Dict[str, ParamMeta]:
    ...
    for param in signature.parameters.values():
        ...
        if isinstance(default, ParameterInfo):
            ...
            if (
                parameter_info.default is ...
                and parameter_info.default_factory
            ):
