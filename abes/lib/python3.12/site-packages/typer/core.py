...
def _typer_param_setup_autocompletion_compat(
    ...
    *,
    autocompletion: Optional[
        Callable[
            [click.Context, List[str], str], List[Union[Tuple[str, str], str]]
        ]
    ] = None,
) -> None:
...
def _get_default_string(
    ...
    *,
    ...
    default_value: Union[
        List[Any], Tuple[Any, ...], str, Callable[..., Any], Any
    ],
) -> str:
    ...
    try:
        try:
            ...
            if e.errno == errno.EPIPE:
                sys.stdout = cast(
                    TextIO, click.utils.PacifyFlushWrapper(sys.stdout)
                )
                sys.stderr = cast(
                    TextIO, click.utils.PacifyFlushWrapper(sys.stderr)
                )
                sys.exit(1)
            else:
                raise
...
class TyperArgument(click.core.Argument):
    ...
    def get_help_record(self, ctx: click.Context) -> Optional[Tuple[str, str]]:
        ...
        if show_default_is_str or (
            ...
            and (self.show_default or ctx.show_default)
        ):
            # Typer override:
