...
class Encoding:
    def __init__(
        ...
        *,
        ...
        if explicit_n_vocab:
            assert (
                len(mergeable_ranks) + len(special_tokens) == explicit_n_vocab
            )
            assert self.max_token_value == explicit_n_vocab - 1

        self._core_bpe = _tiktoken.CoreBPE(
            mergeable_ranks, special_tokens, pat_str
        )
    ...
    def encode_ordinary(self, text: str) -> list[int]:
        ...
        try:
            ...
            text = text.encode('utf-16', 'surrogatepass').decode(
                'utf-16', 'replace'
            )
            return self._core_bpe.encode_ordinary(text)
    ...
    def decode(self, tokens: Sequence[int], errors: str = 'replace') -> str:
        ...
        ```
        """
        return self._core_bpe.decode_bytes(tokens).decode(
            'utf-8', errors=errors
        )
