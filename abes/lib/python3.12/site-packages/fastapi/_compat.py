...
if PYDANTIC_V2:
    ...
    def create_body_model(
        *, fields: Sequence[ModelField], model_name: str
        ...
        field_params = {
            f.name: (f.field_info.annotation, f.field_info) for f in fields
        }
        ...
        *,
        ...
        for model in flat_models:
            ...
            if 'description' in m_schema:
                m_schema['description'] = m_schema['description'].split('\f')[
                    0
                ]
...
def field_annotation_is_complex(annotation: Union[Type[Any], None]) -> bool:
    ...
    if origin is Union or origin is UnionType:
        return any(
            field_annotation_is_complex(arg) for arg in get_args(annotation)
        )
...
def field_annotation_is_scalar(annotation: Any) -> bool:
    ...
    return annotation is Ellipsis or not field_annotation_is_complex(
        annotation
    )
