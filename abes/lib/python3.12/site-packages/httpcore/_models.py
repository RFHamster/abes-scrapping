...
def enforce_headers(
    value: Union[HeadersAsMapping, HeadersAsSequence, None] = None,
    *,
    name: str,
...
def enforce_stream(
    value: Union[bytes, Iterable[bytes], AsyncIterable[bytes], None],
    *,
    name: str,
    ...
    async def aread(self) -> bytes:
        ...
        if not hasattr(self, '_content'):
            self._content = b''.join(
                [part async for part in self.aiter_stream()]
            )
        return self._content
