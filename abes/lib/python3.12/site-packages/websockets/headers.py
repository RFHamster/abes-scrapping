...
def parse_extension(header: str) -> list[ExtensionHeader]:
    ...
    """
    return parse_list(
        parse_extension_item, header, 0, 'Sec-WebSocket-Extensions'
    )
...
def build_extension(extensions: Sequence[ExtensionHeader]) -> str:
    ...
    """
    return ', '.join(
        build_extension_item(name, parameters)
...
def parse_subprotocol(header: str) -> list[Subprotocol]:
    ...
    """
    return parse_list(
        parse_subprotocol_item, header, 0, 'Sec-WebSocket-Protocol'
    )
