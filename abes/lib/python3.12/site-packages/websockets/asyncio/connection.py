...
class Connection(asyncio.Protocol):
    ...
    def __init__(
        ...
        *,
        ...
        self.pong_waiters: dict[
            bytes, tuple[asyncio.Future[float], float]
        ] = {}
    ...
    async def send(
        ...
        # Fragmented message -- async iterator.
            ...
            try:
                ...
                async for chunk in achunks:
                    if isinstance(chunk, str) and text:
                        ...
                        raise TypeError(
                            'async iterable must contain uniform types'
                        )
            ...
            raise TypeError(
                'data must be str, bytes, iterable, or async iterable'
            )
            ...
            try:
                ...
                if self.protocol.close_expected():
                    ...
                    if self.close_timeout is not None:
                        ...
                        self.close_deadline = (
                            self.loop.time() + self.close_timeout
                        )
                ...
                try:
                    ...
                    if self.debug:
                        self.logger.debug(
                            'error while sending data', exc_info=True
                        )
