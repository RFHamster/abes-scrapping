...
class WebSocketCommonProtocol(asyncio.Protocol):
    ...
    * on the server side, when the connection handler terminates.
    ...
    def host(self) -> str | None:
        ...
        warnings.warn(
            f'use {alternative}[0] instead of host', DeprecationWarning
        )
        return self._host
    ...
    def port(self) -> int | None:
        alternative = 'remote_address' if self.is_client else 'local_address'
        warnings.warn(
            f'use {alternative}[1] instead of port', DeprecationWarning
        )
        return self._port
                ...
                if frame.data in self.pings:
                    ...
                    for ping_id, (
                        ...
                        raise AssertionError(
                            'solicited pong not found in pings'
                        )
