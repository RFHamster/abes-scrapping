...
class WebSocketClientProtocol(WebSocketCommonProtocol):
    ...
    async def handshake(
        ...
        request_headers['Host'] = build_host(
            wsuri.host, wsuri.port, wsuri.secure
        )
...
class Connect:
    ...
    * You can set ``host`` and ``port`` to connect to a different host and
    ...
    MAX_REDIRECTS_ALLOWED = int(
        os.environ.get('WEBSOCKETS_MAX_REDIRECTS', '10')
    )
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        create_protocol = cast(
            Callable[..., WebSocketClientProtocol], create_protocol
        )
    ...
    def handle_redirect(self, uri: str) -> None:
        ...
        if not same_origin:
            ...
            factory = functools.partial(
                ...
                *factory.args,
                **dict(
                    factory.keywords, host=new_wsuri.host, port=new_wsuri.port
                ),
            )
    ...
    BACKOFF_INITIAL = float(
        os.environ.get('WEBSOCKETS_BACKOFF_INITIAL_DELAY', '5')
    )
    ...
    BACKOFF_FACTOR = float(
        os.environ.get('WEBSOCKETS_BACKOFF_FACTOR', '1.618')
    )
