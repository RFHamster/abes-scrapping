...
HeadersLikeOrCallable = Union[
    HeadersLike, Callable[[str, Headers], HeadersLike]
]
...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        select_subprotocol: (
            Callable[
                [Sequence[Subprotocol], Sequence[Subprotocol]], Subprotocol
            ]
            | None
        ) = None,
        ...
        * to authenticate the request and return an HTTP 401 Unauthorized or an
        ...
        if self._process_request is not None:
            ...
            if isinstance(response, Awaitable):
                ...
                warnings.warn(
                    'declare process_request as a coroutine',
                    DeprecationWarning,
                )
                return response
        return None
                ...
                for ext_factory in available_extensions:
                    ...
                    try:
                        (
                            response_params,
                            extension,
                        ) = ext_factory.process_request_params(
    ...
    def process_subprotocol(
        self,
        headers: Headers,
        available_subprotocols: Sequence[Subprotocol] | None,
    ) -> Subprotocol | None:
        """
    ...
    def select_subprotocol(
        ...
        if self._select_subprotocol is not None:
            return self._select_subprotocol(
                client_subprotocols, server_subprotocols
            )
        ...
        return sorted(
            subprotocols,
            key=lambda p: client_subprotocols.index(p)
            + server_subprotocols.index(p),
        )[0]
    ...
    async def handshake(
        ...
        self.write_http_response(
            http.HTTPStatus.SWITCHING_PROTOCOLS, response_headers
        )
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if timeout is None:
            ...
            warnings.warn(
                'rename timeout to close_timeout', DeprecationWarning
            )
        ...
        if klass is None:
            ...
            warnings.warn(
                'rename klass to create_protocol', DeprecationWarning
            )
        ...
        create_protocol = cast(
            Callable[..., WebSocketServerProtocol], create_protocol
        )
...
def remove_path_argument(
    ...
    try:
        ...
        try:
            ...
            warnings.warn(
                'remove second argument of ws_handler', DeprecationWarning
            )
