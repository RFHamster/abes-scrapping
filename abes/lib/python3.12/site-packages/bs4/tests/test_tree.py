...
class TestFindAllByAttribute(SoupTest):
    def test_find_all_by_attribute_name(self):
        ...
        self.assert_selects(
            tree.find_all(id='first'), ['Matching a.', 'Matching b.']
        )
    ...
    def test_find_all_by_attribute_dict(self):
        ...
        self.assert_selects(
            tree.find_all(name='name1'), ["A tag called 'name1'."]
        )
        # This does what you want.
        self.assert_selects(
            tree.find_all(attrs={'name': 'name1'}), ['Name match.']
        )

        self.assert_selects(
            tree.find_all(attrs={'class': 'class2'}), ['Class match.']
        )
    ...
    def test_find_all_with_regular_expression_attribute_value(self):
        ...
        self.assert_selects(
            tree.find_all(id=re.compile('^a+$')), ['One a.', 'Two as.']
        )
...
class TestNextSibling(SiblingTest):
    ...
    def test_next_siblings(self):
        self.assert_selects_ids(
            self.start.find_next_siblings('span'), ['2', '3', '4']
        )
...
class TestTreeModification(SoupTest):
    ...
    def test_extend_with_another_tags_contents(self, get_tags):
        ...
        assert (
            '<div id="d2"><a>1</a><a>2</a><a>3</a><a>4</a></div>'
            == d2.decode()
        )
    ...
    def test_extract(self):
        ...
        assert (
            soup.decode()
            == '<html><body>Some content.  More content.</body></html>'
        )
...
<script>baz</script>
    ...
    def test_clear(self):
        """Tag.clear()"""
        soup = self.soup(
            '<p><a>String <em>Italicized</em></a> and another</p>'
        )
        # clear using extract()
        a = soup.a
        soup.p.clear()
    ...
    def test_decompose(self):
        ...
        soup = self.soup(
            '<p><a>String <em>Italicized</em></a></p><p>Another para</p>'
        )
