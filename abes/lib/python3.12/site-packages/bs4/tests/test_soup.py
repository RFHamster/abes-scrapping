...
class TestConstructor(SoupTest):
    ...
    def test_cdata_list_attributes(self):
        ...
        soup = self.soup(
            markup, builder=default_builder, multi_valued_attributes=None
        )
...
class TestWarnings(SoupTest):
    ...
    @pytest.mark.parametrize(
        'extension', ['markuphtml', 'markup.com', '', 'markup.js']
    )
    ...
    def test_url_warning_with_bytes_and_space(self):
        ...
        assert not any(
            'looks more like a URL' in str(w.message) for w in warning_list
        )
