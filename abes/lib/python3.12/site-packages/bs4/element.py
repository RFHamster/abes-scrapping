...
class PageElement(object):
    ...
    def get_text(self, separator='', strip=False, types=default):
        ...
        return separator.join(
            [s for s in self._all_strings(strip, types=types)]
        )
    ...
    def extract(self, _self_index=None):
        ...
        if (
            ...
            and next_element is not self.previous_element
        ):
    ...
    def find_next(self, name=None, attrs={}, string=None, **kwargs):
        ...
        return self._find_one(
            self.find_all_next, name, attrs, string, **kwargs
        )
    ...
    def find_next_sibling(self, name=None, attrs={}, string=None, **kwargs):
        ...
        """
        return self._find_one(
            self.find_next_siblings, name, attrs, string, **kwargs
        )
    ...
    def find_previous_sibling(
        self, name=None, attrs={}, string=None, **kwargs
    ):
...
class Tag(PageElement):
    ...
    def __init__(
        ...
        if builder is None:
            ...
            if self.name in builder.string_containers:
                ...
                self.interesting_string_types = builder.string_containers[
                    self.name
                ]
            else:
    ...
    def decode(
        ...
        for event, element in self._event_stream(iterator):
            ...
            if (
                ...
                event is Tag.END_ELEMENT_EVENT
    ...
    def _format_tag(self, eventual_encoding, formatter, opening):
        ...
        if opening:
            ...
            for key, val in attributes:
                if val is None:
                    ...
                    decoded = (
                        str(key) + '=' + formatter.quoted_attribute_value(text)
                    )
        ...
        if self.is_empty_element:
            void_element_closing_slash = (
                formatter.void_element_close_prefix or ''
            )
...
class SoupStrainer(object):
    ...
    def search_tag(self, markup_name=None, markup_attrs={}):
        ...
        if (
            found
            and self.string
            and not self._matches(found.string, self.string)
        ):
            found = None
        return found
    ...
    def search(self, markup):
        ...
        if hasattr(markup, '__iter__') and not isinstance(markup, (Tag, str)):
            for element in markup:
                if isinstance(element, NavigableString) and self.search(
                    element
                ):
                    found = element
                    break
        ...
        # If it's text, make sure the text matches.
            ...
            if (
                not self.name
                and not self.attrs
                and self._matches(markup, self.string)
            ):
                found = markup
        else:
            raise Exception(
