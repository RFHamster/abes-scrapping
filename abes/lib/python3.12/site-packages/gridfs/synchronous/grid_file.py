...
class GridIn:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not isinstance(root_collection, Collection):
            raise TypeError(
                'root_collection must be an instance of Collection'
            )
    ...
    filename: Optional[str] = _grid_in_property(
        'filename', 'Name of this file.'
    )
    name: Optional[str] = _grid_in_property(
...
class GridOut(GRIDOUT_BASE_CLASS):  # type: ignore
    ...
    length: int = _grid_out_property(
        'length', 'Length (in bytes) of this file.'
    )
    chunk_size: int = _grid_out_property(
    ...
    def __getattr__(self, name: str) -> Any:
        if _IS_SYNC:
            ...
            raise InvalidOperation(
                'You must call GridOut.open() before accessing the %s property'
                % name
            )
...
class GridOutIterator:
    def __init__(
        self, grid_out: GridOut, chunks: Collection, session: ClientSession
    ):
