...
class Headers(typing.MutableMapping[str, str]):
    ...
    def __init__(
        ...
        if headers is None:
            self._list = (
                []
            )  # type: typing.List[typing.Tuple[bytes, bytes, bytes]]
    ...
    def keys(self) -> typing.KeysView[str]:
        return {
            key.decode(self.encoding): None for _, key, value in self._list
        }.keys()
...
class Response:
    def __init__(
        ...
        *,
        ...
        self.extensions: ResponseExtensions = (
    ...
    def iter_bytes(
        ...
        if hasattr(self, '_content'):
            chunk_size = (
                len(self._content) if chunk_size is None else chunk_size
            )
    ...
    async def aread(self) -> bytes:
        ...
        if not hasattr(self, '_content'):
            self._content = b''.join(
                [part async for part in self.aiter_bytes()]
            )
        return self._content
