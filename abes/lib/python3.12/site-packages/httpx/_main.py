...
def print_help() -> None:
    ...
    console.print()
    console.print(
        'Usage: [bold]httpx[/bold] [cyan]<URL> [OPTIONS][/cyan] ',
        justify='left',
    )
    console.print()
...
def get_lexer_for_response(response: Response) -> str:
    ...
    if content_type is not None:
        ...
        try:
            return typing.cast(
                str,
                pygments.lexers.get_lexer_for_mimetype(mime_type.strip()).name,
            )
...
def format_request_headers(
    ...
    headers = [
        (name.lower() if http2 else name, value)
...
def print_request_headers(
    ...
    syntax = rich.syntax.Syntax(
        http_text, 'http', theme='ansi_dark', word_wrap=True
    )
...
def trace(
    ...
    if name == 'connection.connect_tcp.started' and verbose:
        ...
        name == 'connection.start_tls.complete' and verbose
    ):  # pragma: no cover
        stream = info['return_value']
        ...
        name == 'http2.send_request_headers.started' and verbose
    ):  # pragma: no cover
        request = info['request']
