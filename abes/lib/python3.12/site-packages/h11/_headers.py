...
def normalize_and_validate(
    headers: Headers, _parsed: Literal[True]
) -> Headers:
    ...
...
def normalize_and_validate(
    ...
    for name, value in headers:
        ...
        if not _parsed:
            ...
            validate(
                _field_value_re, value, 'Illegal header value {!r}', value
            )
...
def set_comma_header(
    headers: Headers, name: bytes, new_values: List[bytes]
) -> Headers:
    # The header name `name` is expected to be lower-case bytes.
    #
