...
class Config:
    def __init__(
        ...
        if self.should_reload:
            ...
            (
                ...
                self.reload_dirs_excludes,
            ) = resolve_reload_patterns(reload_excludes, [])
        ...
        if forwarded_allow_ips is None:
            ...
            self.forwarded_allow_ips = (
                forwarded_allow_ips  # pragma: full coverage
            )
    ...
    def load(self) -> None:
        ...
        if isinstance(self.ws, str):
            ...
            self.ws_protocol_class: type[
                asyncio.Protocol
            ] | None = ws_protocol_class
        else:
    ...
    def setup_event_loop(self) -> None:
        loop_setup: Callable | None = import_from_string(
    ...
    def bind_socket(self) -> socket.socket:
        ...
        if self.uds:  # pragma: py-win32
            ...
            message = (
                f'Uvicorn running on {addr_format} (Press CTRL+C to quit)'
            )
            color_message = (
                'Uvicorn running on '
        ...
        logger.info(
            message, *logger_args, extra={'color_message': color_message}
        )
