...
if TYPE_CHECKING:
    ...
    Protocols = Union[
        H11Protocol, HttpToolsProtocol, WSProtocol, WebSocketProtocol
    ]
...
class Server:
    ...
    async def _serve(self, sockets: list[socket.socket] | None = None) -> None:
        ...
        logger.info(
            message, process_id, extra={'color_message': color_message}
        )
    ...
    async def on_tick(self, counter: int) -> bool:
        ...
        if (
            ...
            and self.server_state.total_requests >= max_requests
        ):
            logger.warning(
