...
from uvicorn.server import (
    Server,
    ServerState,
)  # noqa: F401  # Used to be defined here.
...
@click.option(
    '--uds', type=str, default=None, help='Bind to a UNIX domain socket.'
)
@click.option(
    '--fd',
    type=int,
...
@click.option(
    '--reload', is_flag=True, default=False, help='Enable auto-reload.'
)
@click.option(
    '--reload-dir',
    'reload_dirs',
