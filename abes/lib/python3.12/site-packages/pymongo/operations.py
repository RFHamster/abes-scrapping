...
class InsertOne(Generic[_DocumentType]):
    ...
    def __init__(
        self, document: _DocumentType, namespace: Optional[str] = None
    ) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        if type(other) == type(self):
            return (
                other._doc == self._doc and other._namespace == self._namespace
            )
...
class _DeleteOp:
    ...
    def __init__(
        ...
        if hint is not None and not isinstance(hint, str):
            ...
            ] = helpers_shared._index_document(hint)
        else:
            self._hint = hint
...
class UpdateOne(_UpdateOp):
    ...
    def __init__(
        ...
        """
        super().__init__(
            filter, update, upsert, collation, array_filters, hint, namespace
        )
