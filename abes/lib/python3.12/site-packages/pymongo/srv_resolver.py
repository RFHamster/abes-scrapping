...
class _SrvResolver:
    ...
    def get_options(self) -> Optional[str]:
        ...
        try:
            results = _resolve(
                self.__fqdn, 'TXT', lifetime=self.__connect_timeout
            )
        ...
        return (b'&'.join([b''.join(res.strings) for res in results])).decode(
            'utf-8'
        )
