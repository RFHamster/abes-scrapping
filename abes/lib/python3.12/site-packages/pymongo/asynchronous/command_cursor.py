...
class AsyncCommandCursor(Generic[_DocumentType]):
    ...
    def __init__(
        ...
        self._postbatchresumetoken: Optional[
            Mapping[str, Any]
        ] = cursor_info.get('postBatchResumeToken')
...
class AsyncRawBatchCommandCursor(AsyncCommandCursor[_DocumentType]):
    ...
    def __getitem__(self, index: int) -> NoReturn:
        raise InvalidOperation(
            'Cannot call __getitem__ on AsyncRawBatchCommandCursor'
        )
