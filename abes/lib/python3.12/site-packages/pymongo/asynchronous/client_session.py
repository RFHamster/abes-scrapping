...
class _Transaction:
    ...
    def __init__(
        self, opts: Optional[TransactionOptions], client: AsyncMongoClient
    ):
        self.opts = opts
...
class AsyncClientSession:
    ...
    async def _finish_transaction_with_retry(
    ...
    async def _finish_transaction(
        self, conn: AsyncConnection, command_name: str
    ) -> dict[str, Any]:
    ...
    def _advance_operation_time(
        self, operation_time: Optional[Timestamp]
    ) -> None:
    ...
    def _update_read_concern(
        self, cmd: MutableMapping[str, Any], conn: AsyncConnection
    ) -> None:
    ...
    def __copy__(self) -> NoReturn:
        raise TypeError(
            'A AsyncClientSession cannot be copied, create a new session instead'
        )
