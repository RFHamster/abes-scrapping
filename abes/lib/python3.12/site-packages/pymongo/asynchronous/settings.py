...
class TopologySettings:
    def __init__(
        ...
        self._seeds: Collection[tuple[str, int]] = seeds or [
            ('localhost', 27017)
        ]
        self._replica_set_name = replica_set_name
        self._pool_class: Type[Pool] = pool_class or pool.Pool
        self._pool_options: PoolOptions = pool_options or PoolOptions()
        self._monitor_class: Type[monitor.Monitor] = (
            monitor_class or monitor.Monitor
        )
        self._condition_class: Type[threading.Condition] = (
            condition_class or threading.Condition
        )
    ...
    def get_server_descriptions(
        self,
    ) -> dict[Union[tuple[str, int], Any], ServerDescription]:
