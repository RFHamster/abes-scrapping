...
def _resumable(exc: PyMongoError) -> bool:
    ...
    if isinstance(exc, OperationFailure):
        ...
        return (
            ...
            exc._max_wire_version < 9 and exc.code in _RESUMABLE_GETMORE_ERRORS
        )
    return False
...
class AsyncChangeStream(Generic[_DocumentType]):
    ...
    def __init__(
        ...
        self._orig_codec_options: CodecOptions[
            _DocumentType
        ] = target.codec_options
    ...
    def _process_result(
        self, result: Mapping[str, Any], conn: AsyncConnection
    ) -> None:
...
class AsyncCollectionChangeStream(AsyncChangeStream[_DocumentType]):
    ...
    @property
    def _aggregation_command_class(
        self,
    ) -> Type[_CollectionAggregationCommand]:
