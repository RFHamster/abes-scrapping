...
class AsyncDatabase(common.BaseObject, Generic[_DocumentType]):
    ...
    async def _get_encrypted_fields(
        ...
        if ask_db and self.client.options.auto_encryption_opts:
            ...
            if options.get('encryptedFields'):
                return cast(
                    Mapping[str, Any], deepcopy(options['encryptedFields'])
                )
        return None
        ...
        **kwargs: Any,
        ...
        async with self._client._tmp_session(session) as s:
            ...
            if (
                ...
                and name
                in await self._list_collection_names(
    ...
    async def cursor_command(
        ...
        **kwargs: Any,
        ...
        async with self._client._tmp_session(
            session, close=False
        ) as tmp_session:
            opts = codec_options or DEFAULT_CODEC_OPTIONS
    ...
    async def _retryable_read_command(
        ...
        return await self._client._retryable_read(
            _cmd, read_preference, session, operation
        )
    ...
    async def list_collections(
        ...
        **kwargs: Any,
        ...
        .. versionadded:: 3.6
        """
        return await self._list_collections_helper(
            session, filter, comment, **kwargs
        )
    ...
    async def _list_collection_names(
        ...
        **kwargs: Any,
        ...
        return [
            result['name']
            async for result in await self._list_collections_helper(
    ...
    async def list_collection_names(
        ...
        **kwargs: Any,
        ...
        .. versionadded:: 3.6
        """
        return await self._list_collection_names(
            session, filter, comment, **kwargs
        )
    ...
    async def _drop_helper(
        ...
        async with await self._client._conn_for_writes(
            session, operation=_Op.DROP
        ) as connection:
            return await self._command(
                connection,
                command,
    ...
    async def validate_collection(
        ...
        if not isinstance(name, str):
            raise TypeError(
                'name_or_collection must be an instance of str or AsyncCollection'
            )
