...
class ServerLogger(monitoring.ServerListener):
    ...
    def description_changed(
        self, event: monitoring.ServerDescriptionChangedEvent
    ) -> None:
...
class HeartbeatLogger(monitoring.ServerHeartbeatListener):
    ...
    def succeeded(
        self, event: monitoring.ServerHeartbeatSucceededEvent
    ) -> None:
...
class TopologyLogger(monitoring.TopologyListener):
    ...
    def description_changed(
        self, event: monitoring.TopologyDescriptionChangedEvent
    ) -> None:
        logging.info(
...
class ConnectionPoolLogger(monitoring.ConnectionPoolListener):
    ...
    def connection_created(
        self, event: monitoring.ConnectionCreatedEvent
    ) -> None:
        logging.info(
    ...
    def connection_closed(
        self, event: monitoring.ConnectionClosedEvent
    ) -> None:
        logging.info(
    ...
    def connection_check_out_failed(
        self, event: monitoring.ConnectionCheckOutFailedEvent
    ) -> None:
        logging.info(
    ...
    def connection_checked_out(
        self, event: monitoring.ConnectionCheckedOutEvent
    ) -> None:
        logging.info(
    ...
    def connection_checked_in(
        self, event: monitoring.ConnectionCheckedInEvent
    ) -> None:
        logging.info(
