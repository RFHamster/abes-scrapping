...
class DeleteResult(_WriteResult):
    ...
    def __init__(
        self, raw_result: Mapping[str, Any], acknowledged: bool
    ) -> None:
        self.__raw_result = raw_result
        super().__init__(acknowledged)
...
class _BulkWriteResultBase(_WriteResult):
    ...
    def __init__(
        self, bulk_api_result: dict[str, Any], acknowledged: bool
    ) -> None:
...
class BulkWriteResult(_BulkWriteResultBase):
    ...
    def __repr__(self) -> str:
        return f'{self.__class__.__name__}({self.bulk_api_result!r}, acknowledged={self.acknowledged})'
