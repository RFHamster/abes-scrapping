...
class Collation:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if caseLevel is not None:
            self.__document['caseLevel'] = validate_boolean(
                'caseLevel', caseLevel
            )
        ...
        if normalization is not None:
            self.__document['normalization'] = validate_boolean(
                'normalization', normalization
            )
        if backwards is not None:
            self.__document['backwards'] = validate_boolean(
                'backwards', backwards
            )
    ...
    def __repr__(self) -> str:
        ...
        return 'Collation({})'.format(
            ', '.join(f'{key}={document[key]!r}' for key in document)
        )
...
def validate_collation_or_none(
    ...
    if isinstance(value, dict):
        return value
    raise TypeError(
        'collation must be a dict, an instance of collation.Collation, or None.'
    )
