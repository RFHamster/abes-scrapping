...
class Collection(common.BaseObject, Generic[_DocumentType]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not isinstance(database, Database):
            ...
            if not any(
                cls.__name__ == 'Database' for cls in type(database).__mro__
            ):
                raise TypeError(
                    f'Database required but given {type(database).__name__}'
                )
        ...
        if create or kwargs:
            if _IS_SYNC:
                ...
                raise ValueError(
                    'Collection does not support the `create` or `kwargs` arguments.'
                )
    ...
    def create_search_index(
        ...
        **kwargs: Any,
        ...
        return (
            self._create_search_indexes([model], session, comment, **kwargs)
        )[0]
    ...
    def distinct(
        ...
        **kwargs: Any,
        ...
        return self._retryable_non_cursor_read(
