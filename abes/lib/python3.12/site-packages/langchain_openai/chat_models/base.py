...
def _convert_dict_to_message(_dict: Mapping[str, Any]) -> BaseMessage:
    ...
    if role == 'user':
        return HumanMessage(
            content=_dict.get('content', ''), id=id_, name=name
        )
    elif role == 'assistant':
        # Fix for azure
...
def _convert_delta_to_message_chunk(
    ...
    if role == 'user' or default_class == HumanMessageChunk:
        ...
        return FunctionMessageChunk(
            content=content, name=_dict['name'], id=id_
        )
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        if 'response_format' in payload:
            ...
            payload.pop('stream')
            response = (
                await self.root_async_client.beta.chat.completions.parse(
                    **payload
                )
            )
        elif self.include_response_headers:
                ...
                if isinstance(value, list):
                    ...
                    for val in value:
                        ...
                        # This is an approximation.
                            ...
                            num_tokens += len(
                                encoding.encode(val['function']['name'])
                            )
                        else:
                            raise ValueError(
