...
class Threads(SyncAPIResource):
    ...
    def create(
        self,
        *,
        messages: Iterable[thread_create_params.Message]
        | NotGiven = NOT_GIVEN,
    ...
    def create_and_run(
        ...
        *,
        ...
        truncation_strategy: Optional[
            thread_create_and_run_params.TruncationStrategy
        ]
        | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
    ...
    def create_and_run_stream(
        ...
        *,
        ...
        return AsyncAssistantStreamManager(
            request,
            event_handler=event_handler or AsyncAssistantEventHandler(),
        )
