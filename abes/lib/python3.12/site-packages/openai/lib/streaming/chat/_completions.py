...
class ChatCompletionStream(Generic[ResponseFormatT]):
    ...
    def __stream__(
        self,
    ) -> Iterator[ChatCompletionStreamEvent[ResponseFormatT]]:
...
class ChatCompletionStreamState(Generic[ResponseFormatT]):
    def __init__(
        ...
        *,
        ...
        self.__current_completion_snapshot: ParsedChatCompletionSnapshot | None = (
            None
        )
        ...
        for choice in chunk.choices:
            try:
                ...
                choice_snapshot.message = cast(
                    ...
                    construct_type(
                        ...
                        value=accumulate_delta(
                            ...
                            cast(
                                'dict[object, object]', choice.delta.to_dict()
                            ),
                        ),
                    ),
                )
                ...
                for tool_index, prev_tool in enumerate(previous_tool_calls):
                    new_tool = (choice_snapshot.message.tool_calls or [])[
                        tool_index
                    ]
                ...
                choice_snapshot = cast(
                    ...
                    construct_type(
                        ...
                        value={
                            **choice.model_dump(
                                exclude_unset=True, exclude={'delta'}
                            ),
            ...
            for tool_call_chunk in choice.delta.tool_calls or []:
                tool_call_snapshot = (
                    choice_snapshot.message.tool_calls or []
                ...
                if tool_call_snapshot.type == 'function':
                    ...
                    if (
                        ...
                        tool_call_snapshot.function.parsed_arguments = (
                            from_json(
                                bytes(
            ...
            if choice.logprobs is not None:
                if choice_snapshot.logprobs is None:
                    ...
                    if choice.logprobs.content:
                        ...
                        choice_snapshot.logprobs.content.extend(
                    ...
                    if choice.logprobs.refusal:
                        ...
                        choice_snapshot.logprobs.refusal.extend(
        ...
        *,
        ...
        for choice in chunk.choices:
            ...
            if (
                ...
                and choice_snapshot.logprobs is not None
            ):
                if (
                    choice.logprobs.content
                    and choice_snapshot.logprobs.content
                ):
                    events_to_fire.append(
                        build(
                            LogprobsContentDeltaEvent,
                ...
                if (
                    choice.logprobs.refusal
                    and choice_snapshot.logprobs.refusal
                ):
                    events_to_fire.append(
                        build(
                            LogprobsRefusalDeltaEvent,
...
class ChoiceEventState:
    ...
    def _content_done_events(
        ...
        *,
        ...
        if (
            choice_snapshot.message.refusal is not None
            and not self._refusal_done
        ):
        ...
        *,
        ...
        if tool_call_snapshot.type == 'function':
            parsed_arguments = parse_function_tool_arguments(
                input_tools=self._input_tools,
                function=tool_call_snapshot.function,
            )
