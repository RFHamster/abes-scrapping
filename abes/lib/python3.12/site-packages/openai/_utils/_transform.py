...
def transform(
    ...
    """
    transformed = _transform_recursive(
...
def _transform_recursive(
    ...
    *,
    ...
    for annotation in annotations:
        if (
            isinstance(annotation, PropertyInfo)
            and annotation.format is not None
        ):
            return _format_data(
...
async def _async_transform_typeddict(
    ...
    for key, value in data.items():
        ...
        if type_ is None:
            ...
            result[
                _maybe_transform_key(key, type_)
            ] = await _async_transform_recursive(value, annotation=type_)
    return result
