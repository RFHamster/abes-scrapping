...
class APIError(OpenAIError):
    ...
    def __init__(
        ...
        if is_dict(body):
            self.code = cast(
                Any,
                construct_type(type_=Optional[str], value=body.get('code')),
            )
            self.param = cast(
                Any,
                construct_type(type_=Optional[str], value=body.get('param')),
            )
            self.type = cast(
                Any, construct_type(type_=str, value=body.get('type'))
            )
        else:
            self.code = None
            self.param = None
