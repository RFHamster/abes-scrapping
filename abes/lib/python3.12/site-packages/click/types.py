...
class _NumberRangeBase(_NumberParamTypeBase):
    ...
    def _clamp(
        self, bound: float, dir: 'te.Literal[1, -1]', open: bool
    ) -> float:
...
class BoolParamType(ParamType):
    ...
    def convert(
        ...
        self.fail(
            _('{value!r} is not a valid boolean.').format(value=value),
            param,
            ctx,
        )
...
class Tuple(CompositeParamType):
    ...
    def __init__(
        self, types: t.Sequence[t.Union[t.Type[t.Any], ParamType]]
    ) -> None:
...
def convert_type(
    ty: t.Optional[t.Any], default: t.Optional[t.Any] = None
) -> ParamType:
