...
def _is_compat_stream_attr(
    stream: t.TextIO, attr: str, value: t.Optional[str]
) -> bool:
...
class _AtomicFile:
    def __init__(
        self, f: t.IO[t.Any], tmp_filename: str, real_filename: str
    ) -> None:
        self._f = f
    ...
    def __exit__(
        self, exc_type: t.Optional[t.Type[BaseException]], *_: t.Any
    ) -> None:
