...
class TestImportationObject(TestCase):
    ...
    def test_importfrom_future(self):
        ...
        assert (
            binding.source_statement == 'from __future__ import print_function'
        )
...
class Test(TestCase):
    ...
    def test_shadowedByLambda(self):
        self.flakes(
            'import fu; lambda fu: fu', m.UnusedImport, m.RedefinedWhileUnused
        )
    ...
    def test_importStar(self):
        ...
        checker = self.flakes(
            'from fu import *', m.ImportStarUsed, m.UnusedImport
        )
    ...
    def test_importStar_relative(self):
        ...
        checker = self.flakes(
            'from .. import *', m.ImportStarUsed, m.UnusedImport
        )
    ...
    def test_localImportStar(self):
        ...
        error = checker.messages[0]
        assert (
            error.message == "'from %s import *' only allowed at module level"
        )
        assert error.message_args == ('..',)
