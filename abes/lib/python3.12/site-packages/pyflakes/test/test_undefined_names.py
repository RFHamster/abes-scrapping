...
class Test(TestCase):
    ...
    def test_globalImportStar(self):
        ...
        self.flakes(
            'from fu import *; bar', m.ImportStarUsed, m.ImportStarUsage
        )
    ...
    def test_undefinedInGenExpNested(self):
        ...
        """
        self.flakes(
            '(b for b in (a for a in [1, 2, 3] if b) if b)', m.UndefinedName
        )

        self.flakes(
            '(b for b in (a for a in [1, 2, 3] if a) if a)', m.UndefinedName
        )
...
class NameTests(TestCase):
    ...
    def test_impossibleContext(self):
        ...
        self.assertRaises(
            RuntimeError, checker.Checker, tree, file_tokens=file_tokens
        )
