...
def varnames(func: object) -> tuple[tuple[str, ...], tuple[str, ...]]:
    ...
    try:
        ...
        sig = inspect.signature(
            ...
            else func  # type:ignore[arg-type]
        )
    except TypeError:
        return (), ()
...
_CallHistory = List[
    Tuple[Mapping[str, object], Optional[Callable[[Any], None]]]
]
...
class HookCaller:
    ...
    def __call__(self, **kwargs: object) -> Any:
        ...
        firstresult = (
            self.spec.opts.get('firstresult', False) if self.spec else False
        )
...
class _SubsetHookCaller(HookCaller):
    ...
    def __init__(
        self, orig: HookCaller, remove_plugins: AbstractSet[_Plugin]
    ) -> None:
        self._orig = orig
...
class HookSpec:
    ...
    def __init__(
        self, namespace: _Namespace, name: str, opts: HookspecOpts
    ) -> None:
