...
def _get_hours_passed(
    time: datetime.datetime, ref_time: datetime.datetime
) -> float:
...
class TimeWeightedVectorStoreRetriever(BaseRetriever):
    ...
    def _document_get_date(
        self, field: str, document: Document
    ) -> datetime.datetime:
