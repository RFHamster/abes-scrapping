...
class ConversationVectorStoreTokenBufferMemory(ConversationTokenBufferMemory):
    ...
    def memory_retriever(self) -> VectorStoreRetrieverMemory:
        ...
        self._memory_retriever = VectorStoreRetrieverMemory(
    ...
    def load_memory_variables(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            with warnings.catch_warnings():
                ...
                memory_variables = self.memory_retriever.load_memory_variables(
                    inputs
                )
            previous_history = memory_variables[
                self.memory_retriever.memory_key
            ]
