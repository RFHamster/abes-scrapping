...
class SQLRecordManager(RecordManager):
    ...
    def create_schema(self) -> None:
        ...
        if isinstance(self.engine, AsyncEngine):
            raise AssertionError(
                'This method is not supported for async engines.'
            )
    ...
    async def acreate_schema(self) -> None:
        ...
        if not isinstance(self.engine, AsyncEngine):
            raise AssertionError(
                'This method is not supported for sync engines.'
            )
        ...
        with self._make_session() as session:
            ...
            if self.dialect == 'sqlite':
                ...
                raise NotImplementedError(
                    f'Not implemented for dialect {self.dialect}'
                )
            ...
            if not isinstance(dt, float):
                raise AssertionError(
                    f'Unexpected type for datetime: {type(dt)}'
                )
            return dt
    ...
    def update(
        ...
        *,
        ...
        if time_at_least and update_time < time_at_least:
            ...
            raise AssertionError(
                f'Time sync issue: {update_time} < {time_at_least}'
            )
        ...
        with self._make_session() as session:
            if self.dialect == 'sqlite':
                ...
                # This code needs to be generalized a bit to work with more dialects.
                pg_insert_stmt: PgInsertType = pg_insert(
                    UpsertionRecord
                ).values(records_to_upsert)
