...
class FlareChain(Chain):
    ...
    output_parser: FinishedOutputParser = Field(
        default_factory=FinishedOutputParser
    )
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        llm = ChatOpenAI(
            max_tokens=max_generation_len, logprobs=True, temperature=0
        )
