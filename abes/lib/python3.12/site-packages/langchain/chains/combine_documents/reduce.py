...
class ReduceDocumentsChain(BaseCombineDocumentsChain):
    ...
    def _collapse(
        ...
        **kwargs: Any,
        ...
        while num_tokens is not None and num_tokens > _token_max:
            ...
            retries += 1
            if (
                self.collapse_max_retries
                and retries == self.collapse_max_retries
            ):
                raise ValueError(
    ...
    async def _acollapse(
        ...
        **kwargs: Any,
        ...
        async def _collapse_docs_func(
            docs: List[Document], **kwargs: Any
        ) -> str:
        ...
        while num_tokens is not None and num_tokens > _token_max:
            ...
            result_docs = []
            for docs in new_result_doc_list:
                new_doc = await acollapse_docs(
                    docs, _collapse_docs_func, **kwargs
                )
                result_docs.append(new_doc)
            num_tokens = length_func(result_docs, **kwargs)
            retries += 1
