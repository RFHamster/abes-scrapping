...
class _ConfigurableModel(Runnable[LanguageModelInput, Any]):
    def __init__(
        ...
        *,
        ...
        self._queued_declarative_operations: List[
            Tuple[str, Tuple, Dict]
        ] = list(queued_declarative_operations)
    ...
    def with_config(
        ...
        **kwargs: Any,
        ...
        config = RunnableConfig(
            **(config or {}), **cast(RunnableConfig, kwargs)
        )
    ...
    async def ainvoke(
        ...
        **kwargs: Any,
        ...
        return await self._model(config).ainvoke(
    ...
    async def astream(
        ...
        **kwargs: Optional[Any],
        ...
        async for x in self._model(config).astream(
            input, config=config, **kwargs
        ):
            yield x
    ...
    async def atransform(
        ...
        **kwargs: Optional[Any],
        ...
        async for x in self._model(config).atransform(
            input, config=config, **kwargs
        ):
            yield x
