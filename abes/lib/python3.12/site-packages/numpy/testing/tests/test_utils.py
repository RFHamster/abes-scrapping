...
class TestArrayEqual(_GenericTest):
    ...
    def test_recarrays(self):
        ...
        c = np.empty(
            2, [('floupipi', float), ('floupi', float), ('floupa', float)]
        )
...
class TestArrayAlmostEqual(_GenericTest):
    ...
    def test_simple(self):
        ...
        assert_raises(
            AssertionError, lambda: self._assert_func(x, y, decimal=5)
        )
...
class TestAlmostEqual(_GenericTest):
    ...
    def test_nan_item(self):
        ...
        assert_raises(
            AssertionError, lambda: self._assert_func(np.nan, np.inf)
        )
        assert_raises(
            AssertionError, lambda: self._assert_func(np.inf, np.nan)
        )
    ...
    def test_inf_item(self):
        ...
        assert_raises(
            AssertionError, lambda: self._assert_func(-np.inf, np.inf)
        )
...
class TestApproxEqual:
    ...
    def test_simple_0d_arrays(self):
        ...
        assert_raises(
            AssertionError, lambda: self._assert_func(x, y, significant=7)
        )
...
class TestArrayAlmostEqualNulp:
    ...
    def test_float64_fail(self):
        ...
        y = x + x * eps * nulp * 2.0
        assert_raises(
            AssertionError, assert_array_almost_equal_nulp, x, y, nulp
        )
...
class TestStringEqual:
    def test_simple(self):
        ...
        assert_raises(
            AssertionError, lambda: assert_string_equal('foo', 'hello')
        )
    ...
    def test_regex(self):
        ...
        assert_raises(
            AssertionError, lambda: assert_string_equal('aaa', 'a+b')
        )
