...
"""
        ...
        'return': {
            ...
            l_not(
                l_or(iscomplexfunction, isintent_hide)
            ): ',#name#_return_value',
        },
        '_check': l_and(
            isfunction, l_not(isstringfunction), l_not(isfunction_wrap)
        ),
    },
...
""",
        ...
        '_check': l_and(
            isstringfunction, l_not(isfunction_wrap)
        ),  # ???obsolete
    },
    {  # Debugging
...
aux_rules = [
    ...
    {  # Common
        ...
        'need': [
            'len..',
            {hasinitvalue: 'forcomb'},
            {hasinitvalue: 'CFUNCSMESS'},
        ],
        '_check': isarray,
    },
    # Scalararray
...
""",
    ...
    if (f2py_success) {"""
        ...
        '_check': l_and(
            isscalar, l_not(iscomplex), l_not(isstring), isintent_nothide
        ),
    },
    {
        'frompyobj': [
