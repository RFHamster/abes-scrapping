...
class TestCharacterString(util.F2PyTest):
    ...
    def test_output(self, length):
        ...
        assert_array_equal(
            f(np.array(list(map(ord, a)), dtype='u1')), a.encode()
        )
    ...
    def test_2d_array_input(self, length):
        ...
        expected = np.array(
            [[[c for c in item] for item in row] for row in a],
            dtype='u1',
            order='F',
        )
        assert_array_equal(f(a), expected)
...
class TestCharacter(util.F2PyTest):
    ...
    def test_2d_array_input(self, dtype):
        ...
        a = np.array(
            [['a', 'b', 'c'], ['d', 'e', 'f']], dtype=dtype, order='F'
        )
    ...
    def test_array_output(self):
        ...
        assert_array_equal(
            f(list(map(ord, 'abc'))), np.array(list('abc'), dtype='S1')
        )
...
class TestStringScalarArr(util.F2PyTest):
    ...
    def test_char(self):
        for out in (
            self.module.string_test.string,
    ...
    def test_char_arr(self):
        for out in (
            self.module.string_test.strarr,
