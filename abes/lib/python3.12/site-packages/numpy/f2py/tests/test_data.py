...
class TestData(util.F2PyTest):
    ...
    def test_crackedlines(self):
        ...
        assert (
            mod[0]['vars']['my_real_array']['='] == '(/1.0d0, 2.0d0, 3.0d0/)'
        )
...
class TestDataMultiplierF77(util.F2PyTest):
    sources = [
        util.getpath('tests', 'src', 'crackfortran', 'data_multiplier.f')
    ]
...
class TestDataWithCommentsF77(util.F2PyTest):
    sources = [
        util.getpath('tests', 'src', 'crackfortran', 'data_with_comments.f')
    ]
