...
class TestLatexRepr:
    ...
    def test_simple_polynomial(self):
        ...
        p = poly.Polynomial([1, 2, 3])
        assert_equal(
            self.as_latex(p), r'$x \mapsto 1.0 + 2.0\,x + 3.0\,x^{2}$'
        )
    ...
    def test_symbol_basic(self):
        ...
        assert_equal(
            self.as_latex(p), r'$z \mapsto 1.0 + 2.0\,z + 3.0\,z^{2}$'
        )
...
class TestPrintOptions:
    ...
    def test_str(self):
        ...
        assert_equal(
            str(p),
            '0.5 + 0.14285714 x + 14285714.28571429 x**2 '
            '+ (1.42857143e+08) x**3',
        )
        ...
        with printoptions(precision=3):
            assert_equal(
                str(p),
                '0.5 + 0.143 x + 14285714.286 x**2 ' '+ (1.429e+08) x**3',
            )
