...
class TestBasic:
    ...
    def test_from_object_array_unicode(self):
        A = np.array(
            [['abc', 'Sigma \u03a3'], ['long   ', '0123456789']], dtype='O'
        )
        assert_raises(ValueError, np.char.array, (A,))
        B = np.char.array(A, **kw_unicode_true)
        assert_equal(B.dtype.itemsize, 10 * np.array('a', 'U').dtype.itemsize)
        assert_array_equal(
            B, [['abc', 'Sigma \u03a3'], ['long', '0123456789']]
        )
...
class TestWhitespace:
    def setup_method(self):
        self.A = np.array([['abc ', '123  '], ['789 ', 'xyz ']]).view(
            np.chararray
        )
...
class TestComparisons:
    def setup_method(self):
        ...
        self.B = np.array([['efg', '123  '], ['051', 'tuv']]).view(
            np.chararray
        )
...
class TestComparisonsMixed2(TestComparisons):
    ...
    def setup_method(self):
        TestComparisons.setup_method(self)
        self.A = np.array([['abc', '123'], ['789', 'xyz']], np.str_).view(
            np.chararray
        )
...
class TestInformation:
    ...
    def test_endswith(self):
        ...
        assert_array_equal(
            self.A.endswith('3', 0, 3), [[0, 0], [1, 0], [1, 0]]
        )
    ...
    def test_find(self):
        ...
        assert_array_equal(
            self.A.find('a', 0, 2), [[1, -1], [-1, -1], [-1, -1]]
        )
        assert_array_equal(
            self.A.find(['1', 'P']), [[-1, -1], [0, -1], [0, 1]]
        )
    ...
    def test_rfind(self):
        ...
        assert_array_equal(
            self.A.rfind('a', 0, 2), [[1, -1], [-1, -1], [-1, -1]]
        )
        assert_array_equal(
            self.A.rfind(['1', 'P']), [[-1, -1], [0, -1], [0, 2]]
        )
    ...
    def test_rindex(self):
        ...
        assert_(
            issubclass(np.char.rindex('abcba', 'b').dtype.type, np.integer)
        )
    ...
    def test_startswith(self):
        ...
        assert_array_equal(
            self.A.startswith('1', 0, 3), [[0, 0], [1, 0], [1, 0]]
        )
