...
class TestRealScalars:
    ...
    def test_dragon4(self):
        ...
        assert_equal(
            fsci64('9.9999999999999995e-08', **preckwd(16)),
            '9.9999999999999995e-08',
        )
        assert_equal(
            fsci64('9.8813129168249309e-324', **preckwd(16)),
            '9.8813129168249309e-324',
        )
        assert_equal(
            fsci64('9.9999999999999694e-311', **preckwd(16)),
        ...
        assert_equal(
            fpos32('3.14159265358979323846', **preckwd(10)), '3.1415927410'
        )
        assert_equal(
            fsci32('3.14159265358979323846', **preckwd(10)), '3.1415927410e+00'
        )
        assert_equal(
            fpos64('3.14159265358979323846', **preckwd(10)), '3.1415926536'
        )
        assert_equal(
        ...
        assert_equal(
            fpos32(
                f32x, unique=True, fractional=True, min_digits=4, precision=4
            ),
            '340282346638528859811704183484516925440.0000',
        )
        assert_raises(
        ...
        assert_equal(
            fsci64(a, unique=False, precision=15), '-6.310887241768094e-30'
        )
        assert_equal(
            fsci64(a, unique=True, precision=15), '-6.310887241768095e-30'
        )
        assert_equal(
            fsci64(a, unique=True, min_digits=15), '-6.310887241768095e-30'
        )
        assert_equal(
        ...
        assert_equal(
            fsci64(a, unique=True, precision=14), '-6.31088724176809e-30'
        )
        assert_equal(
            fsci64(a, unique=True, min_digits=16), '-6.3108872417680944e-30'
        )
        assert_equal(
            fsci64(a, unique=True, precision=16), '-6.310887241768095e-30'
        )
        assert_equal(
            fsci64(a, unique=True, min_digits=14), '-6.310887241768095e-30'
        )
    ...
    def test_dragon4_interface(self):
        ...
        for tp in tps:
            ...
            assert_equal(
                fpos(tp('-1.0'), pad_left=4, pad_right=4), '  -1.    '
            )
            assert_equal(
                fpos(tp('-10.2'), pad_left=4, pad_right=4), ' -10.2   '
            )
            ...
            assert_equal(
                fsci(tp('1.0'), unique=False, precision=4), '1.0000e+00'
            )
            ...
            assert_equal(
                fpos(tp('1.'), unique=False, precision=4, trim='k'), '1.0000'
            )

            assert_equal(
                fpos(tp('1.'), unique=False, precision=4, trim='.'), '1.'
            )
            assert_equal(
            ...
            assert_equal(
                fpos(tp('1.'), unique=False, precision=4, trim='0'), '1.0'
            )
            assert_equal(
