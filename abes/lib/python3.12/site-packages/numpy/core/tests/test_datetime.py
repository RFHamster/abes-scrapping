...
class TestDateTime:
    ...
    def test_datetime_scalar_construction(self):
        ...
        assert_equal(
            np.datetime64('1950-03-12', 'D'), np.datetime64('1950-03-12')
        )
        assert_equal(
            np.datetime64('1950-03-12T13', 's'),
        ...
        assert_equal(
            repr(np.datetime64('2011-02')), "numpy.datetime64('2011-02')"
        )
        ...
        assert_equal(
            np.datetime64('1920-03-13', 'h'), np.datetime64('1920-03-13T00')
        )
        assert_equal(
            np.datetime64('1920-03', 'm'), np.datetime64('1920-03-01T00:00')
        )
        assert_equal(
            np.datetime64('1920', 's'), np.datetime64('1920-01-01T00:00:00')
        )
        assert_equal(
        ...
        assert_equal(
            np.datetime64('1920-03-13T18', 'D'), np.datetime64('1920-03-13')
        )
        assert_equal(
            np.datetime64('1920-03-13T18:33:12', 'M'), np.datetime64('1920-03')
        )
        assert_equal(
            np.datetime64('1920-03-13T18:33:12.5', 'Y'), np.datetime64('1920')
        )
    ...
    def test_datetime_scalar_construction_timezone(self):
        ...
        with assert_warns(DeprecationWarning):
            assert_equal(
                np.datetime64('2000-01-01T00-08'),
    ...
    def test_timedelta_np_int_construction(self, unit):
        ...
        if unit != 'generic':
            assert_equal(
                np.timedelta64(np.int64(123), unit), np.timedelta64(123, unit)
            )
        else:
    ...
    def test_timedelta_scalar_construction(self):
        ...
        assert_equal(
            repr(np.timedelta64(-3, 's')), "numpy.timedelta64(-3,'s')"
        )
        ...
        assert_equal(
            np.timedelta64(5, 'D'), np.timedelta64(datetime.timedelta(days=5))
        )
        assert_equal(
    ...
    def test_timedelta_scalar_construction_units(self):
        ...
        assert_equal(
            np.datetime64('2010-03-12T17:15').dtype, np.dtype('M8[m]')
        )
        assert_equal(
            np.datetime64('2010-03-12T17:15:08').dtype, np.dtype('M8[s]')
        )

        assert_equal(
            np.datetime64('2010-03-12T17:15:08.1').dtype, np.dtype('M8[ms]')
        )
        assert_equal(
            np.datetime64('2010-03-12T17:15:08.12').dtype, np.dtype('M8[ms]')
        )
        assert_equal(
            np.datetime64('2010-03-12T17:15:08.123').dtype, np.dtype('M8[ms]')
        )
        ...
        assert_equal(
            np.datetime64('2010-03-12T17:15:08.12345').dtype,
            np.dtype('M8[us]'),
        )
        assert_equal(
            np.datetime64('2010-03-12T17:15:08.123456').dtype,
            np.dtype('M8[us]'),
        )

        assert_equal(
            np.datetime64('1970-01-01T00:00:02.1234567').dtype,
            np.dtype('M8[ns]'),
        )
        assert_equal(
            np.datetime64('1970-01-01T00:00:02.12345678').dtype,
            np.dtype('M8[ns]'),
        )
        assert_equal(
            np.datetime64('1970-01-01T00:00:02.123456789').dtype,
            np.dtype('M8[ns]'),
        )

        assert_equal(
            np.datetime64('1970-01-01T00:00:02.1234567890').dtype,
            np.dtype('M8[ps]'),
        )
        assert_equal(
            np.datetime64('1970-01-01T00:00:02.12345678901').dtype,
            np.dtype('M8[ps]'),
        )
        assert_equal(
            np.datetime64('1970-01-01T00:00:02.123456789012').dtype,
            np.dtype('M8[ps]'),
        )

        assert_equal(
            np.datetime64('1970-01-01T00:00:02.1234567890123').dtype,
            np.dtype('M8[fs]'),
        )
        assert_equal(
        ...
        # Python date object
        assert_equal(
            np.datetime64(datetime.date(2010, 4, 16)).dtype, np.dtype('M8[D]')
        )
    ...
    def test_days_creation(self):
        ...
        assert_equal(
            np.array('1967', dtype='M8[D]').astype('i8'), -3 * 365 - 1
        )
        assert_equal(
            np.array('1968', dtype='M8[D]').astype('i8'), -2 * 365 - 1
        )
    ...
    def test_days_to_pydate(self):
        assert_equal(
            np.array('1599', dtype='M8[D]').astype('O'),
            datetime.date(1599, 1, 1),
        )
        assert_equal(
            np.array('1600', dtype='M8[D]').astype('O'),
            datetime.date(1600, 1, 1),
        )
        assert_equal(
            np.array('1601', dtype='M8[D]').astype('O'),
            datetime.date(1601, 1, 1),
        )
        assert_equal(
            np.array('1900', dtype='M8[D]').astype('O'),
            datetime.date(1900, 1, 1),
        )
        assert_equal(
            np.array('1901', dtype='M8[D]').astype('O'),
            datetime.date(1901, 1, 1),
        )
        assert_equal(
            np.array('2000', dtype='M8[D]').astype('O'),
            datetime.date(2000, 1, 1),
        )
        assert_equal(
            np.array('2001', dtype='M8[D]').astype('O'),
        ...
        assert_equal(
            np.array('1600-03-01', dtype='M8[D]').astype('O'),
    ...
    def test_pickle(self):
        ...
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
            ...
            assert_equal(
                pickle.loads(pickle.dumps(scalar, protocol=proto)), scalar
            )
            delta = scalar - np.datetime64('2015-01-01T00:00:00.000000000')
            assert_equal(
                pickle.loads(pickle.dumps(delta, protocol=proto)), delta
            )
    ...
    def test_dtype_promotion(self):
        ...
        assert_raises(
            TypeError, np.promote_types, np.dtype('m8[Y]'), np.dtype('m8[D]')
        )
        assert_raises(
            TypeError, np.promote_types, np.dtype('m8[M]'), np.dtype('m8[W]')
        )
    ...
    def test_cast_overflow(self):
        # gh-4486
        def cast():
            numpy.datetime64('1971-01-01 00:00:00.000000000000000').astype(
                '<M8[D]'
            )
    ...
    def test_month_truncation(self):
        ...
        assert_equal(
            np.array('1945-03-01', dtype='M8[M]'),
    ...
    def test_different_unit_comparison(self):
        ...
        for unit1 in ['Y', 'M', 'D']:
            ...
            for unit2 in ['Y', 'M', 'D']:
                ...
                assert_equal(
                    np.array('1945', dtype=dt1), np.array('1945', dtype=dt2)
                )
                assert_equal(
                    np.array('1970', dtype=dt1), np.array('1970', dtype=dt2)
                )
                assert_equal(
                    np.array('9999', dtype=dt1), np.array('9999', dtype=dt2)
                )
                assert_equal(
                    np.array('10000', dtype=dt1),
                    np.array('10000-01-01', dtype=dt2),
                )
                assert_equal(
                    np.datetime64('1945', unit1), np.datetime64('1945', unit2)
                )
                assert_equal(
                    np.datetime64('1970', unit1), np.datetime64('1970', unit2)
                )
                assert_equal(
                    np.datetime64('9999', unit1), np.datetime64('9999', unit2)
                )
                assert_equal(
                    np.datetime64('10000', unit1),
            ...
            for unit2 in ['D', 'h', 'm', 's', 'ms', 'us']:
                ...
                assert_(
                    np.equal(
                        ...
                        np.array('10000-04-27T00:00:00', dtype='M').astype(
                            dt2
                        ),
                        casting='unsafe',
                    )
    ...
    def test_datetime_add(self):
        for dta, dtb, dtc, dtnat, tda, tdb, tdc in [
            ...
            assert_equal(
                np.add(dta, tdb, casting='unsafe').dtype, np.dtype('M8[h]')
            )
            assert_equal(np.add(tdb, dta, casting='unsafe'), dtc)
            assert_equal(
                np.add(tdb, dta, casting='unsafe').dtype, np.dtype('M8[h]')
            )
    ...
    def test_datetime_subtract(self):
        for dta, dtb, dtc, dtd, dte, dtnat, tda, tdb, tdc in [
            ...
            assert_equal(
                np.subtract(dtc, tdb, casting='unsafe').dtype,
                np.dtype('M8[h]'),
            )
            ...
            assert_equal(
                np.subtract(dtc, dtd, casting='unsafe').dtype,
                np.dtype('m8[h]'),
            )
            assert_equal(
            ...
            assert_equal(
                np.subtract(dtd, dtc, casting='unsafe').dtype,
                np.dtype('m8[h]'),
            )
    ...
    def test_string_parser_error_check(self):
        ...
        assert_raises(
            ValueError, np.array, ['1980-02-03%'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03 q'], np.dtype('M8[us]')
        )

        # Hours must be in range [0, 23]
        assert_raises(
            ValueError, np.array, ['1980-02-03 25'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03T25'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03 24:01'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03T24:01'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03 -1'], np.dtype('M8[us]')
        )
        # No trailing ':'
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:'], np.dtype('M8[us]')
        )
        # Minutes must be in range [0, 59]
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:-1'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:60'], np.dtype('M8[us]')
        )
        # No trailing ':'
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:60:'], np.dtype('M8[us]')
        ...
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:10:-1'], np.dtype('M8[us]')
        )
        assert_raises(
            ValueError, np.array, ['1980-02-03 01:01:60'], np.dtype('M8[us]')
        )
    ...
    def test_datetime_as_string(self):
        ...
        assert_equal(
            np.datetime_as_string(np.datetime64(date, 'M')), '1959-10'
        )
        assert_equal(
            np.datetime_as_string(np.datetime64(date, 'D')), '1959-10-13'
        )
        assert_equal(
            np.datetime_as_string(np.datetime64(datetime, 'h')),
            '1959-10-13T12',
        )
        assert_equal(
            np.datetime_as_string(np.datetime64(datetime, 'm')),
            '1959-10-13T12:34',
        )
        assert_equal(
            np.datetime_as_string(np.datetime64(datetime, 's')),
            '1959-10-13T12:34:56',
        )
        assert_equal(
        ...
        assert_equal(
            np.datetime_as_string(np.datetime64(datetime, 'as')), datetime
        )
        ...
        assert_equal(
            np.datetime_as_string(a, unit='Y', casting='unsafe'), '2032'
        )
        assert_equal(
            np.datetime_as_string(a, unit='M', casting='unsafe'), '2032-07'
        )
        assert_equal(
            np.datetime_as_string(a, unit='W', casting='unsafe'), '2032-07-18'
        )
        assert_equal(
            np.datetime_as_string(a, unit='D', casting='unsafe'), '2032-07-18'
        )
        ...
        assert_equal(
            np.datetime_as_string(a, unit='ms'), '2032-07-18T12:23:34.123'
        )
        assert_equal(
            np.datetime_as_string(a, unit='us'), '2032-07-18T12:23:34.123456'
        )
        assert_equal(
            np.datetime_as_string(a, unit='ns'),
            '2032-07-18T12:23:34.123456000',
        )
        assert_equal(
            np.datetime_as_string(a, unit='ps'),
            '2032-07-18T12:23:34.123456000000',
        )
        assert_equal(
            np.datetime_as_string(a, unit='fs'),
    ...
    @pytest.mark.skipif(
        not _has_pytz, reason='The pytz module is not available.'
    )
    def test_datetime_as_string_timezone(self):
        ...
        assert_equal(
            np.datetime_as_string(a, timezone='naive'), '2010-03-15T06:30'
        )
        assert_equal(
            np.datetime_as_string(a, timezone='UTC'), '2010-03-15T06:30Z'
        )
        assert_(
            np.datetime_as_string(a, timezone='local') != '2010-03-15T06:30'
        )

        b = np.datetime64('2010-02-15T06:30', 'm')

        assert_equal(
            np.datetime_as_string(a, timezone=tz('US/Central')),
            '2010-03-15T01:30-0500',
        )
        assert_equal(
            np.datetime_as_string(a, timezone=tz('US/Eastern')),
            '2010-03-15T02:30-0400',
        )
        assert_equal(
            np.datetime_as_string(a, timezone=tz('US/Pacific')),
            '2010-03-14T23:30-0700',
        )

        assert_equal(
            np.datetime_as_string(b, timezone=tz('US/Central')),
            '2010-02-15T00:30-0600',
        )
        assert_equal(
            np.datetime_as_string(b, timezone=tz('US/Eastern')),
            '2010-02-15T01:30-0500',
        )
        assert_equal(
            np.datetime_as_string(b, timezone=tz('US/Pacific')),
    ...
    def test_datetime_arange(self):
        ...
        assert_equal(
            a,
            np.array(
                ['1950-02-10', '1950-02-09', '1950-02-08', '1950-02-07'],
                dtype='M8[D]',
            ),
        )
    ...
    def test_timedelta_arange(self):
        ...
        # Step of 0 is disallowed
        assert_raises(
            ValueError, np.arange, np.timedelta64(0), np.timedelta64(5), 0
        )
        # Promotion across nonlinear unit boundaries is disallowed
        assert_raises(
            TypeError,
    ...
    def test_datetime_busday_offset(self):
        ...
        assert_equal(
            np.busday_offset('2010-08', 0, roll='backward'),
        ...
        assert_equal(
            np.busday_offset('2010-08', 0, roll='forward'),
            np.datetime64('2010-08-02'),
        )
        assert_equal(
        ...
        assert_equal(
            np.busday_offset('2006-02-01', 25), np.datetime64('2006-03-08')
        )
        assert_equal(
            np.busday_offset('2006-03-08', -25), np.datetime64('2006-02-01')
        )
        assert_equal(
        ...
        assert_equal(
            np.busday_offset(np.datetime64('NaT'), 1, roll='nat'),
            np.datetime64('NaT'),
        )
        assert_equal(
    ...
    def test_datetime_busdaycalendar(self):
        ...
        assert_raises(
            ValueError, np.busdaycalendar, weekmask=[0, 0, 0, 0, 0, 0, 0]
        )
    ...
    def test_datetime_busday_holidays_offset(self):
        ...
        assert_equal(
            np.busday_offset(
                '2011-11-10', 1, holidays=['2011-11-11', '2011-11-11']
            ),
            np.datetime64('2011-11-14'),
        )
        assert_equal(
            np.busday_offset(
                '2011-11-14', -1, holidays=['2011-11-11', '2011-11-11']
            ),
            np.datetime64('2011-11-10'),
        )
        # With a NaT holiday
        ...
        assert_equal(
            np.busday_offset(
                '2011-11-10', 1, holidays=['2011-11-11', '2011-11-24']
            ),
            np.datetime64('2011-11-14'),
        )
        assert_equal(
            np.busday_offset(
                '2011-11-14', -1, holidays=['2011-11-11', '2011-11-24']
            ),
            np.datetime64('2011-11-10'),
        )
        ...
        assert_equal(
            np.busday_offset(
                '2011-11-10', 1, holidays=['2011-10-10', '2011-11-11']
            ),
            np.datetime64('2011-11-14'),
        )
        assert_equal(
            np.busday_offset(
                '2011-11-14', -1, holidays=['2011-10-10', '2011-11-11']
            ),
            np.datetime64('2011-11-10'),
        )
        ...
        assert_equal(
            np.busday_offset(
                '2011-12-25', 0, roll='forward', holidays=holidays
            ),
            np.datetime64('2011-12-27'),
        )
        assert_equal(
            np.busday_offset(
                '2011-12-26', 0, roll='forward', holidays=holidays
            ),
            np.datetime64('2011-12-27'),
        )
        assert_equal(
            np.busday_offset(
                '2011-12-26', 0, roll='backward', holidays=holidays
            ),
    ...
    def test_datetime_busday_holidays_count(self):
        ...
        assert_equal(
            np.busday_count(dates, '2011-01-01', busdaycal=bdd),
            -np.arange(366) - 1,
        )
        ...
        expected[0] = -1
        assert_equal(
            np.busday_count(dates, '2011-12-31', busdaycal=bdd), expected
        )
        # Returns negative value when reversed
        expected = -np.arange(366) + 1
        expected[0] = 0
        assert_equal(
            np.busday_count('2011-12-31', dates, busdaycal=bdd), expected
        )
    ...
    def test_datetime_is_busday(self):
        ...
        assert_equal(
            np.is_busday(holidays, busdaycal=bdd),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            'as',
            pytest.param(
                '10D', marks=pytest.mark.xfail(reason='similar to gh-13197')
            ),
        ],
    )
