...
class TestABC:
    ...
    def test_floats(self):
        for t in sctypes['float']:
            ...
            assert_(
                not issubclass(t, numbers.Rational),
    ...
    def test_complex(self):
        for t in sctypes['complex']:
            ...
            assert_(
                not isinstance(t(), numbers.Real),
                f'{t.__name__} is instance of Real',
            )
            assert_(
                not issubclass(t, numbers.Real),
    ...
    def test_int(self):
        for t in sctypes['int']:
            assert_(
                isinstance(t(), numbers.Integral),
                f'{t.__name__} is not instance of Integral',
            )
            assert_(
                issubclass(t, numbers.Integral),
