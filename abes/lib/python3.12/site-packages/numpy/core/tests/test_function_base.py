...
class TestLogspace:
    ...
    def test_start_stop_array(self):
        ...
        t2 = stack(
            [logspace(_start, _stop, 6) for _start, _stop in zip(start, stop)],
            axis=1,
        )
        assert_equal(t1, t2)
...
class TestLinspace:
    ...
    def test_start_stop_array(self):
        ...
        t2 = stack(
            [linspace(_start, _stop, 5) for _start, _stop in zip(start, stop)],
            axis=1,
        )
        assert_equal(t1, t2)
    ...
    def test_complex(self):
        ...
        t2 = array(
            [0.0 + 1.0j, 2.5 + 0.75j, 5.0 + 0.5j, 7.5 + 0.25j, 10.0 + 0j]
        )
    ...
    def test_equivalent_to_arange(self):
        for j in range(1000):
            assert_equal(
                linspace(0, j, j + 1, dtype=int), arange(j + 1, dtype=int)
            )
