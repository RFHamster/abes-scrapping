...
class TestFromrecords:
    ...
    def test_method_array(self):
        r = np.rec.array(
            b'abcdefg' * 100, formats='i2,a3,i4', shape=3, byteorder='big'
        )
    ...
    def test_recarray_fromfile(self):
        ...
        bytes_array.seek(0)
        r3 = np.rec.fromfile(
            bytes_array, formats='f8,i4,a5', shape=3, byteorder='big'
        )
        fd.close()
        assert_equal(r1, r2)
        assert_equal(r2, r3)
    ...
    def test_recarray_repr(self):
        a = np.array(
            [(1, 0.1), (2, 0.2)], dtype=[('foo', '<i4'), ('bar', '<f8')]
        )
        a = np.rec.array(a)
        assert_equal(
            repr(a),
    ...
    def test_recarray_from_repr(self):
        a = np.array(
            [(1, 'ABC'), (2, 'DEF')], dtype=[('foo', int), ('bar', 'S4')]
        )
    ...
    def test_recarray_stringtypes(self):
        # Issue #3993
        a = np.array(
            [('abc ', 1), ('abc', 2)], dtype=[('foo', 'S4'), ('bar', int)]
        )
...
class TestRecord:
    ...
    def test_out_of_order_fields(self):
        ...
        assert_equal(
            x.dtype.descr, [('col1', '<i4'), ('col2', '<i4'), ('', '|V4')]
        )
    ...
    def test_pickle_1(self):
        ...
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
            ...
            assert_equal(
                a[0], pickle.loads(pickle.dumps(a[0], protocol=proto))
            )
