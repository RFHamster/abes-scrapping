...
class format_parser:
    ...
    def _setfieldnames(self, names, titles):
        ...
        self._names += [
            'f%d' % i for i in range(len(self._names), self._nfields)
        ]
    ...
    def __getattribute__(self, attr):
        ...
        if res:
            ...
            raise AttributeError(
                "'record' object has no " "attribute '%s'" % attr
            )
...
class recarray(ndarray):
    ...
    def __setattr__(self, attr, val):
        ...
        if (
            attr == 'dtype'
            and issubclass(val.type, nt.void)
    ...
    def __repr__(self):
        ...
        if self.dtype.type is record or not issubclass(
            self.dtype.type, nt.void
        ):
