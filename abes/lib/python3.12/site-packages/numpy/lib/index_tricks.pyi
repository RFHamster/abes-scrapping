...
@overload
def ix_(
    *args: bytes | _NestedSequence[bytes],
) -> tuple[NDArray[bytes_], ...]: ...
@overload
...
@overload
def ix_(
    *args: float | _NestedSequence[float],
) -> tuple[NDArray[float_], ...]: ...
@overload
def ix_(
    *args: complex | _NestedSequence[complex],
) -> tuple[NDArray[complex_], ...]: ...
...
class IndexExpression(Generic[_BoolType]):
    ...
    @overload
    def __getitem__(
        self: IndexExpression[Literal[True]], item: _T
    ) -> tuple[_T]: ...
    @overload
...
def fill_diagonal(
    a: ndarray[Any, Any], val: Any, wrap: bool = ...
) -> None: ...
