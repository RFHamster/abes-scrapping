...
class TestSetOps:
    ...
    def test_in1d_boolean(self, kind):
        ...
        assert_array_equal(
            np.invert(expected), in1d(a, b, invert=True, kind=kind)
        )
...
class TestUnique:
    def test_unique_1d(self):
        ...
        a3_idx, a3_inv = np.unique(a, return_index=True, return_inverse=True)[
            1:
        ]
    ...
    def test_unique_axis_zeros(self):
        ...
        for axis in range(len(shape)):
            ...
            assert_array_equal(
                unique(multiple_zeros, axis=axis),
    ...
    def test_unique_masked(self):
        # issue 8664
        x = np.array(
            [64, 0, 1, 2, 3, 63, 63, 0, 0, 0, 1, 2, 0, 63, 0], dtype='uint8'
        )
