...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    ...
    if hasattr(object, '_ppimport_importer') or hasattr(
...
@set_module('numpy')
def lookfor(
    what, module=None, import_modules=True, regenerate=False, output=None
):
    """
            ...
            if import_modules and hasattr(item, '__path__'):
                for pth in item.__path__:
                    for mod_path in os.listdir(pth):
                        ...
                        if os.path.isfile(this_py) and mod_path.endswith(
                            '.py'
                        ):
