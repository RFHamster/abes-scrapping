...
class dtype(Generic[_DTypeScalar_co]):
    ...
    def __new__(
        cls,
        dtype: _UIntCodes | type[ct.c_ulong],
        align: bool = ...,
        copy: bool = ...,
        metadata: dict[builtins.str, Any] = ...,
    ) -> dtype[uint]: ...
    ...
    def __new__(
        cls,
        dtype: _IntCodes | type[ct.c_long],
        align: bool = ...,
        copy: bool = ...,
        metadata: dict[builtins.str, Any] = ...,
    ) -> dtype[int_]: ...
    ...
    @overload
    def __getitem__(
        self: dtype[void], key: list[builtins.str]
    ) -> dtype[void]: ...
    @overload
    def __getitem__(
    ...
    def descr(
        ...
        | tuple[builtins.str, builtins.str, _Shape]
    ]: ...
    @property
    def fields(
        self,
    ) -> None | MappingProxyType[
        builtins.str, tuple[dtype[Any], int] | tuple[dtype[Any], int, Any]
    ]: ...
    @property
    def flags(self) -> int: ...
    @property
    ...
    def newbyteorder(
        self: _DType, __new_order: _ByteOrder = ...
    ) -> _DType: ...
    @property
...
class flatiter(Generic[_NdArraySubClass]):
    ...
    def __getitem__(
        ...
        | slice
        | ellipsis
        | tuple[_ArrayLikeInt | slice | ellipsis],
    ) -> _NdArraySubClass: ...
    ...
    @overload
    def __array__(
        self: flatiter[ndarray[Any, _DType]], dtype: None = ..., /
    ) -> ndarray[Any, _DType]: ...
    @overload
...
class _ArrayOrScalarCommon:
    ...
    def __deepcopy__(
        self: _ArraySelf, memo: None | dict[int, Any], /
    ) -> _ArraySelf: ...
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    def __getitem__(
        ...
        key: (
            ...
            | _ArrayLikeInt_co
            | tuple[
                None | slice | ellipsis | _ArrayLikeInt_co | SupportsIndex, ...
            ]
        ),
    ) -> ndarray[Any, _DType_co]: ...
    @overload
    ...
    @overload
    def resize(
        self, new_shape: _ShapeLike, /, *, refcheck: bool = ...
    ) -> None: ...
    @overload
    def resize(
        self, *new_shape: SupportsIndex, refcheck: bool = ...
    ) -> None: ...
    def setflags(
    ...
    @overload
    def transpose(
        self: _ArraySelf, axes: None | _ShapeLike, /
    ) -> _ArraySelf: ...
    @overload
    ...
    @overload
    def getfield(
        self, dtype: DTypeLike, offset: SupportsIndex = ...
    ) -> NDArray[Any]: ...
    ...
    @overload
    def __lt__(
        self: NDArray[Any], other: _ArrayLikeObject_co
    ) -> NDArray[bool_]: ...
    @overload
    def __le__(
        self: _ArrayNumber_co, other: _ArrayLikeNumber_co
    ...
    @overload
    def __matmul__(
        self: NDArray[number[Any]], other: _ArrayLikeNumber_co
    ) -> NDArray[number[Any]]: ...
    @overload
    ...
    @overload
    def __sub__(
        self: NDArray[_UnknownType], other: _ArrayLikeUnknown
    ) -> NDArray[Any]: ...
    @overload
    def __sub__(
    ...
    @overload
    def __rfloordiv__(
        self: NDArray[bool_], other: _ArrayLikeTD64_co
    ) -> NoReturn: ...
    @overload
    def __rfloordiv__(
        self: _ArrayFloat_co, other: _ArrayLikeTD64_co
    ...
    @overload
    def __iadd__(
        self: NDArray[unsignedinteger[_NBit1]],
    ...
    def __dlpack__(
        self: NDArray[number[Any]], *, stream: None = ...
    ) -> _PyCapsule: ...
...
class generic(_ArrayOrScalarCommon):
    ...
    def byteswap(
        self: _ScalarType, inplace: L[False] = ...
    ) -> _ScalarType: ...
    @property
    def flat(
        self: _ScalarType,
    ) -> flatiter[ndarray[Any, _dtype[_ScalarType]]]: ...
    ...
    def transpose(
        self: _ScalarType, axes: None | tuple[()] = ..., /
    ) -> _ScalarType: ...
    # Keep `dtype` at the bottom to avoid name conflicts with `np.dtype`
    @property
...
class integer(number[_NBit1]):  # type: ignore
    ...
    @overload
    def __round__(
        self: _ScalarType, ndigits: SupportsIndex
    ) -> _ScalarType: ...
...
class floating(inexact[_NBit1]):
    ...
    def __getformat__(
        self: float64, typestr: L['double', 'float'], /
    ) -> str: ...
    @overload
    def __round__(self, ndigits: None = ...) -> int: ...
    @overload
...
class void(flexible):
    @overload
    def __init__(
        self, value: _IntLike_co | bytes, /, dtype: None = ...
    ) -> None: ...
    @overload
...
class ndenumerate(Generic[_ScalarType]):
    ...
    def __new__(
        cls,
        arr: _FiniteNestedSequence[_SupportsArray[dtype[_ScalarType]]],
    ) -> ndenumerate[_ScalarType]: ...
    @overload
    def __new__(cls, arr: str | _NestedSequence[str]) -> ndenumerate[str_]: ...
    @overload
    def __new__(
        cls, arr: bytes | _NestedSequence[bytes]
    ) -> ndenumerate[bytes_]: ...
    @overload
    def __new__(
        cls, arr: bool | _NestedSequence[bool]
    ) -> ndenumerate[bool_]: ...
    @overload
    def __new__(cls, arr: int | _NestedSequence[int]) -> ndenumerate[int_]: ...
    @overload
    def __new__(
        cls, arr: float | _NestedSequence[float]
    ) -> ndenumerate[float_]: ...
    @overload
    def __new__(
        cls, arr: complex | _NestedSequence[complex]
    ) -> ndenumerate[complex_]: ...
    def __next__(
        self: ndenumerate[_ScalarType],
    ) -> tuple[_Shape, _ScalarType]: ...
...
class iinfo(Generic[_IntType]):
    ...
    @overload
    def __new__(
        cls, dtype: _IntType | _DTypeLike[_IntType]
    ) -> iinfo[_IntType]: ...
    @overload
...
class recarray(ndarray[_ShapeType, _DType_co]):
    ...
    def __getitem__(
        self, indx: list[str]
    ) -> recarray[_ShapeType, dtype[record]]: ...
    @overload
...
class nditer:
    ...
    def __setitem__(
        self, index: slice | SupportsIndex, value: ArrayLike
    ) -> None: ...
    def close(self) -> None: ...
...
class matrix(ndarray[_ShapeType, _DType_co]):
    ...
    ) -> matrix[Any, dtype[Any]]: ...
    @overload
    def __getitem__(
        self: NDArray[void], key: list[str]
    ) -> matrix[_ShapeType, dtype[void]]: ...
    ...
    ) -> matrix[Any, dtype[bool_]]: ...
    @overload
    def any(
        self, axis: None | _ShapeLike = ..., out: _NdArraySubClass = ...
    ) -> _NdArraySubClass: ...
    @overload
    ...
    @overload
    def max(
        self: NDArray[_ScalarType], axis: None = ..., out: None = ...
    ) -> _ScalarType: ...
    @overload
    def max(
        self, axis: _ShapeLike, out: None = ...
...
class chararray(ndarray[_ShapeType, _CharDType]):
    ...
    def splitlines(
        self, keepends: None | _ArrayLikeBool_co = ...
    ) -> NDArray[object_]: ...
    @overload
    def startswith(
        self: _CharArray[str_],
