...
class Array:
    ...
    def __complex__(self: Array, /) -> complex:
        ...
        if self._array.ndim != 0:
            raise TypeError(
                'complex is only allowed on arrays with 0 dimensions'
            )
    ...
    def __float__(self: Array, /) -> float:
        ...
        if self.dtype in _complex_floating_dtypes:
            raise TypeError(
                'float is not allowed on complex floating-point arrays'
            )
    ...
    def __int__(self: Array, /) -> int:
        ...
        if self.dtype in _complex_floating_dtypes:
            raise TypeError(
                'int is not allowed on complex floating-point arrays'
            )
    ...
    def __ifloordiv__(
        ...
        """
        other = self._check_allowed_dtypes(
            other, 'real numeric', '__ifloordiv__'
        )
        if other is NotImplemented:
            return other
    ...
    def __rfloordiv__(
        ...
        """
        other = self._check_allowed_dtypes(
            other, 'real numeric', '__rfloordiv__'
        )
        if other is NotImplemented:
            return other
        self, other = self._normalize_two_args(self, other)
    ...
    def to_device(
        ...
        if stream is not None:
            raise ValueError(
                'The stream argument to to_device() is not supported'
            )
        if device == 'cpu':
            return self
