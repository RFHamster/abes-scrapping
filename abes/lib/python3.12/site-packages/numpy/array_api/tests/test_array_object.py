                ...
                for a in _array_vals():
                    ...
                    if (
                        (
                            ...
                            and a.dtype in _real_numeric_dtypes
                            or dtypes == 'integer'
                        ...
                        and (
                            ...
                            and type(s) == int
                            or a.dtype in _real_floating_dtypes
                            and type(s) in [float, int]
                            or a.dtype in _complex_floating_dtypes
                            and type(s) in [complex, float, int]
                        )
                    ):
                        if a.dtype in _integer_dtypes and s == BIG_INT:
                            assert_raises(
                                OverflowError, lambda: getattr(a, _op)(s)
                            )
                        else:
                    ...
                    for x in _array_vals():
                        for y in _array_vals():
                            ...
                            if (
                                ...
                                assert_raises(
                                    TypeError, lambda: getattr(x, _op)(y)
                                )
                            ...
                            # Ensure only those dtypes that are required for every operator are allowed.
                                ...
                                or (
                                    dtypes == 'real numeric'
                                    and x.dtype in _real_numeric_dtypes
                                    and y.dtype in _real_numeric_dtypes
                                )
                                or (
                                    dtypes == 'numeric'
