...
def atan2(x1: Array, x2: Array, /) -> Array:
    ...
    """
    if (
        x1.dtype not in _real_floating_dtypes
        or x2.dtype not in _real_floating_dtypes
    ):
...
def conj(x: Array, /) -> Array:
    ...
    if x.dtype not in _complex_floating_dtypes:
        raise TypeError(
            'Only complex floating-point dtypes are allowed in conj'
        )
...
def floor_divide(x1: Array, x2: Array, /) -> Array:
    ...
    """
    if (
        x1.dtype not in _real_numeric_dtypes
        or x2.dtype not in _real_numeric_dtypes
    ):
...
def greater_equal(x1: Array, x2: Array, /) -> Array:
    ...
    if (
        ...
        raise TypeError(
            'Only real numeric dtypes are allowed in greater_equal'
        )
    # Call result type here just to raise on disallowed type combinations
    _result_type(x1.dtype, x2.dtype)
    x1, x2 = Array._normalize_two_args(x1, x2)
...
def imag(x: Array, /) -> Array:
    ...
    if x.dtype not in _complex_floating_dtypes:
        raise TypeError(
            'Only complex floating-point dtypes are allowed in imag'
        )
...
def logaddexp(x1: Array, x2: Array) -> Array:
    ...
    if (
        ...
        raise TypeError(
            'Only real floating-point dtypes are allowed in logaddexp'
        )
    # Call result type here just to raise on disallowed type combinations
    _result_type(x1.dtype, x2.dtype)
    x1, x2 = Array._normalize_two_args(x1, x2)
...
def real(x: Array, /) -> Array:
    ...
    if x.dtype not in _complex_floating_dtypes:
        raise TypeError(
            'Only complex floating-point dtypes are allowed in real'
        )
