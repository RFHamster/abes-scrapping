...
class TestSeed:
    ...
    def test_invalid_array_shape(self):
        # gh-9832
        assert_raises(
            ValueError, np.random.RandomState, np.array([], dtype=np.int64)
        )
        assert_raises(ValueError, np.random.RandomState, [[1, 2, 3]])
        assert_raises(
            ValueError, np.random.RandomState, [[1, 2, 3], [4, 5, 6]]
        )
...
class TestMultinomial:
    ...
    def test_size(self):
        ...
        assert_equal(np.random.multinomial(1, p, (2, 2)).shape, (2, 2, 2))
        assert_equal(
            np.random.multinomial(1, p, np.array((2, 2))).shape, (2, 2, 2)
        )
    ...
    def test_multidimensional_pvals(self):
        ...
        assert_raises(ValueError, np.random.multinomial, 10, [[0], [1]])
        assert_raises(
            ValueError, np.random.multinomial, 10, [[[0], [1]], [[1], [0]]]
        )
        assert_raises(
            ValueError, np.random.multinomial, 10, np.array([[0, 1], [1, 0]])
        )
...
class TestRandomDist:
    ...
    def test_random_integers_max_int(self):
        ...
        with suppress_warnings() as sup:
            w = sup.record(DeprecationWarning)
            actual = np.random.random_integers(
    ...
    def test_choice_return_shape(self):
        ...
        assert_equal(
            np.random.choice(['a', 'b'], size=(3, 0, 4)).shape, (3, 0, 4)
        )
    ...
    def test_scalar_exception_propagation(self):
        ...
        assert_raises(
            TypeError, np.random.uniform, throwing_float, throwing_float
        )
