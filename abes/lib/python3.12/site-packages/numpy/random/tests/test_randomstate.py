...
class TestSeed:
    ...
    def test_invalid_array_shape(self):
        # gh-9832
        assert_raises(
            ValueError, random.RandomState, np.array([], dtype=np.int64)
        )
...
class TestRandomDist:
    ...
    def test_random_integers_deprecated(self):
        with warnings.catch_warnings():
            ...
            assert_raises(
                DeprecationWarning, random.random_integers, np.iinfo('l').max
            )
...
class TestBroadcast:
    ...
    def test_normal(self):
        ...
        desired = np.array(
            [2.2129019979039612, 2.1283977976520019, 1.8417114045748335]
        )
    ...
    def test_gamma(self):
        ...
        gamma = random.gamma
        desired = np.array(
            [1.5221370731769048, 1.5277256455738331, 1.4248762625178359]
        )
    ...
    def test_noncentral_f(self):
        ...
        desired = np.array(
            [9.1393943263705211, 13.025456344595602, 8.8018098359100545]
        )
    ...
    def test_noncentral_chisquare(self):
        ...
        desired = np.array(
            [9.0015599467913763, 4.5804135049718742, 6.0872302432834564]
        )
    ...
    def test_standard_t(self):
        ...
        t = random.standard_t
        desired = np.array(
            [3.0702872575217643, 5.8560725167361607, 1.0274791436474273]
        )
    ...
    def test_pareto(self):
        ...
        desired = np.array(
            [1.1405622680198362, 1.1465519762044529, 1.0389564467453547]
        )
    ...
    def test_lognormal(self):
        ...
        desired = np.array(
            [9.1422086044848427, 8.4013952870126261, 6.3073234116578671]
        )
    ...
    def test_rayleigh(self):
        ...
        desired = np.array(
            [1.2337491937897689, 1.2360119924878694, 1.1936818095781789]
        )
    ...
    def test_triangular(self):
        ...
        desired = np.array(
            [2.03339048710429, 2.0347400359389356, 2.0095991069536208]
        )
