...
class _ndptr(ctypes.c_void_p, Generic[_DTypeOptional]):
    ...
    @classmethod
    def from_param(
        cls: type[_ndptr[None]], obj: ndarray[Any, Any]
    ) -> _ctypes[Any]: ...
    @overload
    @classmethod
    def from_param(
        cls: type[_ndptr[_DType]], obj: ndarray[Any, _DType]
    ) -> _ctypes[Any]: ...
...
@overload
def as_ctypes_type(
    dtype: _LongDoubleCodes
    | _DTypeLike[longdouble]
...
@overload
def as_array(
    obj: ctypes._PointerLike, shape: Sequence[int]
) -> NDArray[Any]: ...
@overload
def as_array(
...
@overload
def as_ctypes(
    obj: NDArray[longdouble],
) -> ctypes.Array[ctypes.c_longdouble]: ...
@overload
def as_ctypes(
    obj: NDArray[void],
