...
assert_type(
    np.fromregex(bytes_file, 'test', np.float64), npt.NDArray[np.float64]
)
...
assert_type(
    np.fromregex(pathlib_path, 'test', np.float64), npt.NDArray[np.float64]
)
assert_type(
    np.fromregex(bytes_reader, 'test', np.float64), npt.NDArray[np.float64]
)
...
assert_type(
    np.genfromtxt(str_path, dtype=str, skip_header=2), npt.NDArray[Any]
)
...
assert_type(
    np.recfromtxt(['1', '2', '3']), np.recarray[Any, np.dtype[np.record]]
)
...
assert_type(
    np.recfromcsv(['1', '2', '3']), np.recarray[Any, np.dtype[np.record]]
)
