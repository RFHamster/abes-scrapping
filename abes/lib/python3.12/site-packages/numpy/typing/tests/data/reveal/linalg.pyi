...
assert_type(
    np.linalg.tensorsolve(AR_c16, AR_f8),
...
assert_type(
    np.linalg.solve(AR_c16, AR_f8), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.tensorinv(AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.cholesky(AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.eigvals(AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.svd(AR_f8, compute_uv=False), npt.NDArray[np.floating[Any]]
)
assert_type(
    np.linalg.svd(AR_c16, compute_uv=False), npt.NDArray[np.floating[Any]]
)
