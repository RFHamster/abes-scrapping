...
assert_type(
    np.correlate(B, AR_i8, mode='valid'), npt.NDArray[np.signedinteger[Any]]
)
assert_type(
    np.correlate(AR_i8, AR_i8, mode='same'), npt.NDArray[np.signedinteger[Any]]
)
...
assert_type(
    np.correlate(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
assert_type(np.correlate(AR_i8, AR_m), npt.NDArray[np.timedelta64])
assert_type(np.correlate(AR_O, AR_O), npt.NDArray[np.object_])

assert_type(
    np.convolve(B, AR_i8, mode='valid'), npt.NDArray[np.signedinteger[Any]]
)
assert_type(
    np.convolve(AR_i8, AR_i8, mode='same'), npt.NDArray[np.signedinteger[Any]]
)
...
assert_type(
    np.convolve(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.tensordot(AR_i8, AR_i8, axes=0), npt.NDArray[np.signedinteger[Any]]
)
assert_type(
    np.tensordot(AR_i8, AR_i8, axes=(0, 1)), npt.NDArray[np.signedinteger[Any]]
)
...
assert_type(
    np.tensordot(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.indices([0, 1, 2], sparse=True), tuple[npt.NDArray[np.int_], ...]
)
