...
SEED_ARR: np.ndarray[Any, np.dtype[np.int64]] = np.array(
...
I_bool_high_open: np.ndarray[Any, np.dtype[np.bool_]] = np.array(
    [1], dtype=np.bool_
)
I_bool_high_closed: np.ndarray[Any, np.dtype[np.bool_]] = np.array(
    [1], dtype=np.bool_
)
...
I_i2_low: np.ndarray[Any, np.dtype[np.int16]] = np.array(
    [-32768], dtype=np.int16
)
I_i2_low_like: list[int] = [-32768]
I_i2_high_open: np.ndarray[Any, np.dtype[np.int16]] = np.array(
