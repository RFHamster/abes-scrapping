...
assert_type(
    divmod(AR_m, td), tuple[npt.NDArray[np.int64], npt.NDArray[np.timedelta64]]
)
assert_type(
    divmod(td, AR_m), tuple[npt.NDArray[np.int64], npt.NDArray[np.timedelta64]]
)
...
assert_type(
    divmod(b_, AR_b), tuple[npt.NDArray[np.int8], npt.NDArray[np.int8]]
)
...
assert_type(
    divmod(AR_b, b_), tuple[npt.NDArray[np.int8], npt.NDArray[np.int8]]
)
...
assert_type(
    divmod(i8, i4),
    tuple[
        np.signedinteger[_32Bit | _64Bit], np.signedinteger[_32Bit | _64Bit]
    ],
)
assert_type(
    divmod(i8, f4),
    tuple[np.floating[_32Bit | _64Bit], np.floating[_32Bit | _64Bit]],
)
...
assert_type(
    divmod(i8, AR_b),
    tuple[
        npt.NDArray[np.signedinteger[Any]], npt.NDArray[np.signedinteger[Any]]
    ],
)
