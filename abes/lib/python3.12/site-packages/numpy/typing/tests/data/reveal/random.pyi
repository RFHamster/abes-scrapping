...
assert_type(
    seed_seq.generate_state(8, 'uint32'), npt.NDArray[np.uint32 | np.uint64]
)
assert_type(
    seed_seq.generate_state(8, 'uint64'), npt.NDArray[np.uint32 | np.uint64]
)
...
assert_type(
    def_gen.standard_normal(size=1, dtype=np.float32), npt.NDArray[np.float32]
)
assert_type(
    def_gen.standard_normal(size=1, dtype='f4'), npt.NDArray[np.float32]
)
assert_type(
...
assert_type(
    def_gen.standard_normal(size=1, dtype=np.float64), npt.NDArray[np.float64]
)
assert_type(
    def_gen.standard_normal(size=1, dtype='float64'), npt.NDArray[np.float64]
)
assert_type(
    def_gen.standard_normal(size=1, dtype='f8'), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.random(size=1, dtype='float32', out=S_out), npt.NDArray[np.float32]
)
assert_type(
    def_gen.random(dtype=np.float32, out=S_out), npt.NDArray[np.float32]
)
...
assert_type(def_gen.random(size=1, dtype='float64'), npt.NDArray[np.float64])
assert_type(
    def_gen.random(size=1, dtype='float64', out=D_out), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.standard_exponential(size=1, method='inv'), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.standard_exponential(size=1, dtype='f8'), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.standard_t(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.exponential(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.standard_gamma(D_arr_0p5, dtype='f4'), npt.NDArray[np.float32]
)
assert_type(
...
assert_type(
    def_gen.standard_gamma(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(def_gen.standard_gamma(0.5, out=D_out), npt.NDArray[np.float64])
assert_type(
    def_gen.standard_gamma(D_arr_like_0p5, out=D_out), npt.NDArray[np.float64]
)
assert_type(
    def_gen.standard_gamma(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
    def_gen.standard_gamma(
        D_arr_like_0p5, size=1, out=D_out, dtype=np.float64
    ),
    npt.NDArray[np.float64],
)
...
assert_type(
    def_gen.vonmises(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.vonmises(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.wald(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.wald(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.uniform(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.uniform(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.beta(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.beta(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.f(D_arr_like_0p5, D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.gamma(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.gamma(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.gumbel(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.gumbel(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.laplace(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.laplace(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.logistic(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.logistic(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.lognormal(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.lognormal(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.noncentral_chisquare(0.5, 0.5, size=1), npt.NDArray[np.float64]
)
assert_type(
    def_gen.noncentral_chisquare(D_arr_0p5, 0.5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.noncentral_chisquare(0.5, D_arr_0p5), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.noncentral_chisquare(D_arr_like_0p5, 0.5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.noncentral_chisquare(0.5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.noncentral_chisquare(D_arr_0p5, D_arr_0p5), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.normal(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    def_gen.normal(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.triangular(0.1, D_arr_0p5, 0.9, size=1), npt.NDArray[np.float64]
)
assert_type(
    def_gen.triangular(D_arr_like_0p1, 0.5, D_arr_0p9), npt.NDArray[np.float64]
)
assert_type(
    def_gen.triangular(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
    def_gen.triangular(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.noncentral_f(0.1, 0.5, 0.9, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    def_gen.noncentral_f(0.1, D_arr_0p5, 0.9, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.noncentral_f(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
    def_gen.noncentral_f(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    def_gen.noncentral_f(
        D_arr_like_0p1, D_arr_like_0p5, D_arr_like_0p9, size=1
    ),
    npt.NDArray[np.float64],
)
...
assert_type(
    def_gen.binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.int64]
)
assert_type(
    def_gen.binomial(I_arr_10, D_arr_0p5, size=1), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.negative_binomial(I_arr_10, 0.5, size=1), npt.NDArray[np.int64]
)
assert_type(
    def_gen.negative_binomial(10, D_arr_0p5, size=1), npt.NDArray[np.int64]
)
assert_type(
    def_gen.negative_binomial(I_arr_like_10, 0.5), npt.NDArray[np.int64]
)
assert_type(
    def_gen.negative_binomial(10, D_arr_like_0p5), npt.NDArray[np.int64]
)
assert_type(
    def_gen.negative_binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.hypergeometric(20, I_arr_20, 10, size=1), npt.NDArray[np.int64]
)
assert_type(
    def_gen.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.int64]
)
assert_type(
    def_gen.hypergeometric(20, I_arr_like_20, 10), npt.NDArray[np.int64]
)
assert_type(
    def_gen.hypergeometric(I_arr_20, I_arr_20, 10), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.hypergeometric(
        I_arr_like_20, I_arr_like_20, I_arr_like_10, size=1
    ),
    npt.NDArray[np.int64],
)

I_int64_100: np.ndarray[Any, np.dtype[np.int64]] = np.array(
    [100], dtype=np.int64
)
...
assert_type(
    def_gen.integers(I_bool_high_open, dtype=bool), npt.NDArray[np.bool_]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_bool_high_open, dtype=bool), npt.NDArray[np.bool_]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_bool_low, I_bool_high_closed, dtype=bool, endpoint=True
    ),
    npt.NDArray[np.bool_],
)
assert_type(
...
assert_type(
    def_gen.integers(I_bool_high_open, dtype=np.bool_), npt.NDArray[np.bool_]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_bool_low, I_bool_high_closed, dtype=np.bool_, endpoint=True
    ),
    npt.NDArray[np.bool_],
)
assert_type(
...
I_u1_high_open: np.ndarray[Any, np.dtype[np.uint8]] = np.array(
    [255], dtype=np.uint8
)
...
assert_type(
    def_gen.integers(I_u1_high_open, dtype='u1'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u1_high_open, dtype='u1'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(I_u1_high_open, dtype='uint8'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u1_high_open, dtype='uint8'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u1_low, I_u1_high_closed, dtype=np.uint8, endpoint=True
    ),
    npt.NDArray[np.uint8],
)
assert_type(
...
assert_type(
    def_gen.integers(I_u2_high_open, dtype='u2'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u2_high_open, dtype='u2'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    def_gen.integers(I_u2_high_open, dtype='uint16'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u2_high_open, dtype='uint16'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u2_low, I_u2_high_closed, dtype='uint16', endpoint=True
    ),
    npt.NDArray[np.uint16],
)
assert_type(
...
assert_type(
    def_gen.integers(I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u2_low, I_u2_high_closed, dtype=np.uint16, endpoint=True
    ),
    npt.NDArray[np.uint16],
)
assert_type(
...
assert_type(
    def_gen.integers(I_u4_high_open, dtype=np.int_), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype=np.int_), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    def_gen.integers(I_u4_high_open, dtype='u4'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype='u4'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    def_gen.integers(0, 4294967295, dtype='uint32', endpoint=True), int
)
assert_type(
...
assert_type(
    def_gen.integers(I_u4_high_open, dtype='uint32'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype='uint32'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u4_low, I_u4_high_closed, dtype='uint32', endpoint=True
    ),
    npt.NDArray[np.uint32],
)
assert_type(
...
assert_type(
    def_gen.integers(0, 4294967295, dtype=np.uint32, endpoint=True), int
)
assert_type(
    def_gen.integers(
        I_u4_low_like, 4294967295, dtype=np.uint32, endpoint=True
    ),
    npt.NDArray[np.uint32],
)
assert_type(
    def_gen.integers(I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u4_low, I_u4_high_closed, dtype=np.uint32, endpoint=True
    ),
    npt.NDArray[np.uint32],
)
assert_type(
...
assert_type(
    def_gen.integers(I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint]
)
assert_type(
...
assert_type(
    def_gen.integers(18446744073709551615, dtype='u8', endpoint=True), int
)
assert_type(
    def_gen.integers(0, 18446744073709551615, dtype='u8', endpoint=True), int
)
assert_type(
    def_gen.integers(
        I_u8_low_like, 18446744073709551615, dtype='u8', endpoint=True
    ),
    npt.NDArray[np.uint64],
)
assert_type(
    def_gen.integers(I_u8_high_open, dtype='u8'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u8_high_open, dtype='u8'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    def_gen.integers(18446744073709551615, dtype='uint64', endpoint=True), int
)
assert_type(
...
assert_type(
    def_gen.integers(I_u8_high_open, dtype='uint64'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u8_high_open, dtype='uint64'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u8_low, I_u8_high_closed, dtype='uint64', endpoint=True
    ),
    npt.NDArray[np.uint64],
)
assert_type(
...
assert_type(
    def_gen.integers(18446744073709551615, dtype=np.uint64, endpoint=True), int
)
assert_type(
...
assert_type(
    def_gen.integers(I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_u8_low, I_u8_high_closed, dtype=np.uint64, endpoint=True
    ),
    npt.NDArray[np.uint64],
)
assert_type(
...
I_i1_high_open: np.ndarray[Any, np.dtype[np.int8]] = np.array(
    [127], dtype=np.int8
)
I_i1_high_closed: np.ndarray[Any, np.dtype[np.int8]] = np.array(
    [127], dtype=np.int8
)
...
assert_type(
    def_gen.integers(-128, I_i1_high_open, dtype='i1'), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    def_gen.integers(I_i1_high_open, dtype='int8'), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    def_gen.integers(-128, I_i1_high_open, dtype='int8'), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    def_gen.integers(I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    def_gen.integers(-128, I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    def_gen.integers(I_i2_high_open, dtype='i2'), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    def_gen.integers(-32768, I_i2_high_open, dtype='i2'), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    def_gen.integers(I_i2_high_open, dtype='int16'), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    def_gen.integers(-32768, 32767, dtype=np.int16, endpoint=True), int
)
assert_type(
...
assert_type(
    def_gen.integers(I_i2_high_open, dtype=np.int16), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_i2_low, I_i2_high_closed, dtype=np.int16, endpoint=True
    ),
    npt.NDArray[np.int16],
)
assert_type(
...
I_i4_low: np.ndarray[Any, np.dtype[np.int32]] = np.array(
    [-2147483648], dtype=np.int32
)
...
assert_type(
    def_gen.integers(-2147483648, 2147483647, dtype='i4', endpoint=True), int
)
assert_type(
...
assert_type(
    def_gen.integers(I_i4_high_open, dtype='i4'), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    def_gen.integers(I_i4_high_open, dtype='int32'), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    def_gen.integers(
        -2147483648, I_i4_high_closed, dtype='int32', endpoint=True
    ),
    npt.NDArray[np.int32],
)
...
assert_type(
    def_gen.integers(I_i4_high_open, dtype=np.int32), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_i4_low, I_i4_high_closed, dtype=np.int32, endpoint=True
    ),
    npt.NDArray[np.int32],
)
assert_type(
    def_gen.integers(
        -2147483648, I_i4_high_closed, dtype=np.int32, endpoint=True
    ),
    npt.NDArray[np.int32],
)
...
assert_type(
    def_gen.integers(9223372036854775807, dtype='i8', endpoint=True), int
)
assert_type(
    def_gen.integers(
...
assert_type(
    def_gen.integers(
        I_i8_low_like, 9223372036854775807, dtype='i8', endpoint=True
    ),
    npt.NDArray[np.int64],
)
assert_type(
    def_gen.integers(I_i8_high_open, dtype='i8'), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.integers(
        -9223372036854775808, I_i8_high_closed, dtype='i8', endpoint=True
    ),
    npt.NDArray[np.int64],
)
...
assert_type(
    def_gen.integers(9223372036854775807, dtype='int64', endpoint=True), int
)
assert_type(
    def_gen.integers(
...
assert_type(
    def_gen.integers(
        I_i8_low_like, 9223372036854775807, dtype='int64', endpoint=True
    ),
    npt.NDArray[np.int64],
)
assert_type(
    def_gen.integers(I_i8_high_open, dtype='int64'), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.integers(9223372036854775807, dtype=np.int64, endpoint=True), int
)
assert_type(
    def_gen.integers(
        -9223372036854775808,
...
assert_type(
    def_gen.integers(
        I_i8_low_like, 9223372036854775807, dtype=np.int64, endpoint=True
    ),
    npt.NDArray[np.int64],
)
assert_type(
    def_gen.integers(I_i8_high_open, dtype=np.int64), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_i8_low, I_i8_high_closed, dtype=np.int64, endpoint=True
    ),
    npt.NDArray[np.int64],
)
assert_type(
...
assert_type(
    def_gen.choice(5, 3, p=[1 / 5] * 5, replace=False), npt.NDArray[np.int64]
)
...
assert_type(
    def_gen.choice(
        ['pooh', 'rabbit', 'piglet', 'Christopher'], 3, p=[1 / 4] * 4
    ),
    np.ndarray[Any, Any],
)
assert_type(
    def_gen.choice(
        ['pooh', 'rabbit', 'piglet', 'Christopher'], 3, replace=True
    ),
    np.ndarray[Any, Any],
)
assert_type(
...
assert_type(
    def_gen.dirichlet(np.array([0.5, 0.5]), size=3), npt.NDArray[np.float64]
)

assert_type(def_gen.multinomial(20, [1 / 6.0] * 6), npt.NDArray[np.int64])
assert_type(
    def_gen.multinomial(20, np.array([0.5, 0.5])), npt.NDArray[np.int64]
)
assert_type(
    def_gen.multinomial(20, [1 / 6.0] * 6, size=2), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.multinomial(
        np.array([[10], [20]]), np.array([0.5, 0.5]), size=(2, 2)
    ),
    npt.NDArray[np.int64],
)

assert_type(
    def_gen.multivariate_hypergeometric([3, 5, 7], 2), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    def_gen.multivariate_hypergeometric(
        np.array([3, 5, 7]), 2, method='marginals'
    ),
    npt.NDArray[np.int64],
)

assert_type(
    def_gen.multivariate_normal([0.0], [[1.0]]), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.standard_t(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.chisquare(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.exponential(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.rayleigh(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.standard_gamma(D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(random_st.standard_gamma(D_arr_like_0p5), npt.NDArray[np.float64])
assert_type(
    random_st.standard_gamma(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.standard_gamma(D_arr_like_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.vonmises(D_arr_0p5, 0.5, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.vonmises(0.5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.vonmises(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.vonmises(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.wald(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.wald(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.uniform(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.uniform(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.beta(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.beta(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.f(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.gamma(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.gamma(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.gumbel(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.gumbel(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.laplace(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.laplace(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.logistic(D_arr_0p5, 0.5, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.logistic(0.5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.logistic(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.logistic(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.lognormal(D_arr_0p5, 0.5, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.lognormal(0.5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.lognormal(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.noncentral_chisquare(0.5, 0.5, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.noncentral_chisquare(D_arr_0p5, 0.5), npt.NDArray[np.float64]
)
assert_type(
    random_st.noncentral_chisquare(0.5, D_arr_0p5), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.normal(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64]
)
assert_type(
    random_st.normal(D_arr_0p5, D_arr_0p5, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.triangular(0.1, 0.5, 0.9, size=1), npt.NDArray[np.float64]
)
...
assert_type(
    random_st.triangular(0.1, D_arr_0p5, 0.9, size=1), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.triangular(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
    random_st.triangular(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.noncentral_f(0.1, 0.5, 0.9, size=1), npt.NDArray[np.float64]
)
assert_type(
    random_st.noncentral_f(D_arr_0p1, 0.5, 0.9), npt.NDArray[np.float64]
)
assert_type(
    random_st.noncentral_f(0.1, D_arr_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.noncentral_f(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
    random_st.noncentral_f(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.int_]
)
assert_type(
    random_st.binomial(I_arr_10, D_arr_0p5, size=1), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    random_st.negative_binomial(I_arr_10, 0.5, size=1), npt.NDArray[np.int_]
)
assert_type(
    random_st.negative_binomial(10, D_arr_0p5, size=1), npt.NDArray[np.int_]
)
assert_type(
    random_st.negative_binomial(I_arr_like_10, 0.5), npt.NDArray[np.int_]
)
assert_type(
    random_st.negative_binomial(10, D_arr_like_0p5), npt.NDArray[np.int_]
)
assert_type(
    random_st.negative_binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    random_st.hypergeometric(20, I_arr_20, 10, size=1), npt.NDArray[np.int_]
)
assert_type(
    random_st.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.int_]
)
assert_type(
    random_st.hypergeometric(20, I_arr_like_20, 10), npt.NDArray[np.int_]
)
assert_type(
    random_st.hypergeometric(I_arr_20, I_arr_20, 10), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    random_st.randint(I_bool_high_open, dtype=bool), npt.NDArray[np.bool_]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_bool_high_open, dtype=bool), npt.NDArray[np.bool_]
)

assert_type(random_st.randint(2, dtype=np.bool_), bool)
assert_type(random_st.randint(0, 2, dtype=np.bool_), bool)
assert_type(
    random_st.randint(I_bool_high_open, dtype=np.bool_), npt.NDArray[np.bool_]
)
assert_type(
...
assert_type(
    random_st.randint(I_u1_high_open, dtype='u1'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u1_high_open, dtype='u1'), npt.NDArray[np.uint8]
)

assert_type(random_st.randint(256, dtype='uint8'), int)
assert_type(random_st.randint(0, 256, dtype='uint8'), int)
assert_type(
    random_st.randint(I_u1_high_open, dtype='uint8'), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u1_high_open, dtype='uint8'), npt.NDArray[np.uint8]
)

assert_type(random_st.randint(256, dtype=np.uint8), int)
assert_type(random_st.randint(0, 256, dtype=np.uint8), int)
assert_type(
    random_st.randint(I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8]
)

assert_type(random_st.randint(65536, dtype='u2'), int)
assert_type(random_st.randint(0, 65536, dtype='u2'), int)
assert_type(
    random_st.randint(I_u2_high_open, dtype='u2'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u2_high_open, dtype='u2'), npt.NDArray[np.uint16]
)

assert_type(random_st.randint(65536, dtype='uint16'), int)
assert_type(random_st.randint(0, 65536, dtype='uint16'), int)
assert_type(
    random_st.randint(I_u2_high_open, dtype='uint16'), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    random_st.randint(I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16]
)
assert_type(
...
assert_type(
    random_st.randint(I_u4_high_open, dtype='u4'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype='u4'), npt.NDArray[np.uint32]
)

assert_type(random_st.randint(4294967296, dtype='uint32'), int)
assert_type(random_st.randint(0, 4294967296, dtype='uint32'), int)
assert_type(
    random_st.randint(I_u4_high_open, dtype='uint32'), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    random_st.randint(I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32]
)
assert_type(
...
assert_type(
    random_st.randint(I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint]
)
...
assert_type(
    random_st.randint(I_u8_high_open, dtype='u8'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u8_high_open, dtype='u8'), npt.NDArray[np.uint64]
)
...
assert_type(
    random_st.randint(I_u8_high_open, dtype='uint64'), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    random_st.randint(I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64]
)
assert_type(
...
assert_type(
    random_st.randint(I_i1_high_open, dtype='i1'), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    random_st.randint(-128, I_i1_high_open, dtype='i1'), npt.NDArray[np.int8]
)

assert_type(random_st.randint(128, dtype='int8'), int)
assert_type(random_st.randint(-128, 128, dtype='int8'), int)
assert_type(
    random_st.randint(I_i1_high_open, dtype='int8'), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    random_st.randint(-128, I_i1_high_open, dtype='int8'), npt.NDArray[np.int8]
)

assert_type(random_st.randint(128, dtype=np.int8), int)
assert_type(random_st.randint(-128, 128, dtype=np.int8), int)
assert_type(
    random_st.randint(I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8]
)
assert_type(
...
assert_type(
    random_st.randint(I_i2_high_open, dtype='i2'), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    random_st.randint(I_i2_high_open, dtype='int16'), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    random_st.randint(I_i2_high_open, dtype=np.int16), npt.NDArray[np.int16]
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype='i4'), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype='int32'), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype=np.int32), npt.NDArray[np.int32]
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype=np.int_), npt.NDArray[np.int_]
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_high_open, dtype='i8'), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_high_open, dtype='int64'), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_high_open, dtype=np.int64), npt.NDArray[np.int64]
)
assert_type(
...
assert_type(
    random_st.choice(5, 3, p=[1 / 5] * 5, replace=False), npt.NDArray[np.int_]
)
...
assert_type(
    random_st.dirichlet(np.array([0.5, 0.5]), size=3), npt.NDArray[np.float64]
)

assert_type(random_st.multinomial(20, [1 / 6.0] * 6), npt.NDArray[np.int_])
assert_type(
    random_st.multinomial(20, np.array([0.5, 0.5])), npt.NDArray[np.int_]
)
assert_type(
    random_st.multinomial(20, [1 / 6.0] * 6, size=2), npt.NDArray[np.int_]
)

assert_type(
    random_st.multivariate_normal([0.0], [[1.0]]), npt.NDArray[np.float64]
)
assert_type(
...
assert_type(
    random_st.permutation(np.array([1, 2, 3, 4])), np.ndarray[Any, Any]
)
