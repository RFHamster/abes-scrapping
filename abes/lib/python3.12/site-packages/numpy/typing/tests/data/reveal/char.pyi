...
assert_type(
    np.char.partition(AR_S, [b'a', b'b', b'c']), npt.NDArray[np.bytes_]
)
assert_type(np.char.rpartition(AR_U, '\n'), npt.NDArray[np.str_])
assert_type(
    np.char.rpartition(AR_S, [b'a', b'b', b'c']), npt.NDArray[np.bytes_]
)

assert_type(np.char.replace(AR_U, '_', '-'), npt.NDArray[np.str_])
assert_type(
    np.char.replace(AR_S, [b'_', b''], [b'a', b'b']), npt.NDArray[np.bytes_]
)
...
assert_type(
    np.char.count(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.int_]
)

assert_type(
    np.char.endswith(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.bool_]
)
assert_type(
    np.char.endswith(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.bool_]
)
assert_type(
    np.char.startswith(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.bool_]
)
assert_type(
    np.char.startswith(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.bool_]
)

assert_type(np.char.find(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(
    np.char.find(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.int_]
)
assert_type(np.char.rfind(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(
    np.char.rfind(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.int_]
)

assert_type(np.char.index(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(
    np.char.index(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.int_]
)
assert_type(np.char.rindex(AR_U, 'a', start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(
    np.char.rindex(AR_S, [b'a', b'b', b'c'], end=9), npt.NDArray[np.int_]
)
...
assert_type(
    np.char.array(AR_S, order='K'), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.array('bob', copy=True), np.chararray[Any, np.dtype[np.str_]]
)
assert_type(
    np.char.array(b'bob', itemsize=5), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.array(1, unicode=False), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.array(1, unicode=True), np.chararray[Any, np.dtype[np.str_]]
)

assert_type(np.char.asarray(AR_U), np.chararray[Any, np.dtype[np.str_]])
assert_type(
    np.char.asarray(AR_S, order='K'), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(np.char.asarray('bob'), np.chararray[Any, np.dtype[np.str_]])
assert_type(
    np.char.asarray(b'bob', itemsize=5), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.asarray(1, unicode=False), np.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.asarray(1, unicode=True), np.chararray[Any, np.dtype[np.str_]]
)
