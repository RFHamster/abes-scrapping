...
assert_type(
    np.seterrcall(func), Callable[[str, int], Any] | None | SupportsWrite
)
assert_type(
    np.seterrcall(Write()), Callable[[str, int], Any] | None | SupportsWrite
)
...
assert_type(
    np.errstate(call=Write(), divide='log', over='log'), np.errstate[Write]
)
