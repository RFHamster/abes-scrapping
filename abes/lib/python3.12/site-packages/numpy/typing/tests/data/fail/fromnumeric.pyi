...
np.argpartition(
    ...
    order=range(
        5
    ),  # E: Argument "order" to "argpartition" has incompatible type
)
...
np.sort(
    A, order=range(5)
)  # E: Argument "order" to "sort" has incompatible type

np.argsort(
    A, axis='bob'
)  # E: Argument "axis" to "argsort" has incompatible type
np.argsort(
    A, kind='bob'
)  # E: Argument "kind" to "argsort" has incompatible type
np.argsort(
    A, order=range(5)
)  # E: Argument "order" to "argsort" has incompatible type

np.argmax(
    A, axis='bob'
)  # E: No overload variant of "argmax" matches argument type
np.argmax(
    A, kind='bob'
)  # E: No overload variant of "argmax" matches argument type
...
np.argmin(
    A, axis='bob'
)  # E: No overload variant of "argmin" matches argument type
np.argmin(
    A, kind='bob'
)  # E: No overload variant of "argmin" matches argument type
...
np.clip(
    a, 1, 2, out=1
)  # E: No overload variant of "clip" matches argument type
