...
assert_type(
    np.einsum('i,i,i,i->i', AR_LIKE_b, AR_LIKE_u, AR_LIKE_i, AR_LIKE_c), Any
)
...
assert_type(
    np.einsum(
        'i,i->i', AR_LIKE_U, AR_LIKE_U, dtype=bool, casting='unsafe', out=OUT_f
    ),
    npt.NDArray[np.float64],
)
...
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_b, AR_LIKE_b), tuple[list[Any], str]
)
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_u, AR_LIKE_u), tuple[list[Any], str]
)
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_i, AR_LIKE_i), tuple[list[Any], str]
)
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_f, AR_LIKE_f), tuple[list[Any], str]
)
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_c, AR_LIKE_c), tuple[list[Any], str]
)
assert_type(
    np.einsum_path('i,i->i', AR_LIKE_b, AR_LIKE_i), tuple[list[Any], str]
)
assert_type(
...
assert_type(
    np.einsum_path([[1, 1], [1, 1]], AR_LIKE_i, AR_LIKE_i),
    tuple[list[Any], str],
)
