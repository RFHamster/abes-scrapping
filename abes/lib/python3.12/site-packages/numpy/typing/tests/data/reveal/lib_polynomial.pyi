...
assert_type(
    np.polyint(AR_f8, k=AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.polyval(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.polyadd(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.polysub(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.polymul(AR_i8, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
