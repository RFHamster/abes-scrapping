...
class TestMa:
    ...
    def test_testOddFeatures(self):
        ...
        assert_(
            eq(
                masked_where(greater_equal(x, 2), x),
        ...
        assert_(
            eq(
                masked_equal(
                    array(list(range(5)), mask=[1, 0, 0, 0, 0]), 2
                ).mask,
                [1, 0, 1, 0, 0],
            )
        )
        ...
        assert_(
            eq(
                masked_where([1, 1, 0, 0, 0], [1, 2, 3, 4, 5]),
                [99, 99, 3, 4, 5],
            )
        )
...
class TestArrayMethods:
    ...
    def test_trace(self):
        ...
        assert_(
            eq(mX.trace(), X.trace() - sum(mXdiag.mask * X.diagonal(), axis=0))
        )
