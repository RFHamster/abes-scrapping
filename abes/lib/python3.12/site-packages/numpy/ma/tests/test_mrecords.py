...
class TestMRecords:
    ...
    def test_set_mask(self):
        ...
        assert_equal(
            mbase._mask.tolist(), np.array([(1, 1, 1)] * 5, dtype=bool)
        )
        # Delete the mask ............................
        mbase.mask = nomask
        assert_equal(ma.getmaskarray(mbase['c']), [0] * 5)
        assert_equal(
            mbase._mask.tolist(), np.array([(0, 0, 0)] * 5, dtype=bool)
        )
    ...
    def test_set_elements(self):
        ...
        assert_equal(
            mbase.c._data, [b'one', b'two', b'three', b'four', b'five']
        )
        assert_equal(mbase.b._mask, [1, 1, 0, 0, 1])
    ...
    def test_setslices_hardmask(self):
        ...
        try:
            ...
            assert_equal(
                mbase.c._data, [b'one', b'two', b'three', b'5', b'five']
            )
            assert_equal(mbase.a._mask, [0, 1, 0, 0, 1])
    ...
    def test_hardmask(self):
        ...
        assert_equal_records(
            mbase._mask, ma.make_mask_none(base.shape, base.dtype)
        )
    ...
    def test_filled(self):
        ...
        assert_equal(
            mrecfilled['b'], np.array((1.1, 2.2, 99999.0), dtype=float)
        )
        assert_equal(
            mrecfilled['c'], np.array(('one', 'two', 'N/A'), dtype='|S8')
        )
    ...
    def test_tolist(self):
        ...
        assert_equal(
            mrec.tolist(),
            [(1, 1.1, None), (2, 2.2, b'two'), (None, None, b'three')],
        )
    ...
    def test_exotic_formats(self):
        ...
        solo[0] = masked
        assert_equal(
            solo.filled(1).item(), np.array((1,), dtype=solo.dtype).item()
        )
...
class TestMRecordsImport:
    ...
    def test_fromrecords_wmask(self):
        ...
        _mrec = fromrecords(
            nrec.tolist(), dtype=ddtype, mask=mrec._mask.tolist()
        )
        assert_equal_records(_mrec._data, mrec._data)
        assert_equal(_mrec._mask.tolist(), mrec._mask.tolist())
