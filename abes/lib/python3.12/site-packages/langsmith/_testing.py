...
def _get_test_suite_name(func: Callable) -> str:
    ...
    raise ValueError(
        'Please set the LANGSMITH_TEST_SUITE environment variable.'
    )
...
class _LangSmithTestSuite:
    ...
    def submit_result(
        ...
        self._executor.submit(
            self._submit_result, run_id, error, skipped=skipped
        )
...
def _ensure_example(
    ...
    test_suite.sync_example(
        ...
        outputs,
        metadata={
            'signature': _get_test_repr(func, signature),
            'name': example_name,
        },
    )
    ...
    def _test():
        ...
        with rh.trace(
            ...
            try:
                ...
                logger.warning(
                    f'Failed to create feedback for run_id {run_id}: {e}'
                )
