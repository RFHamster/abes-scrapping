        ...
        if c.delta.function_call:
            ...
            if c.delta.function_call.arguments:
                message['function_call'][
                    'arguments'
                ] += c.delta.function_call.arguments
    ...
    if tool_calls:
        ...
        for index, tool_call_chunks in tool_calls.items():
            message['tool_calls'][index] = {
                ...
                'type': next(
                    (c.type for c in tool_call_chunks if c.type), None
                ),
            }
...
def _create_usage_metadata(oai_token_usage: dict) -> UsageMetadata:
    ...
    total_tokens = (
        oai_token_usage.get('total_tokens') or input_tokens + output_tokens
    )
