...
def _is_pydantic_annotation(
    annotation: Any, pydantic_version: str = 'v2'
) -> bool:
...
def create_schema_from_function(
    ...
    *,
    ...
    if filter_args:
        ...
        if (
            existing_params
            and existing_params[0] in ('self', 'cls')
            and in_class
        ):
    ...
    async def arun(
        ...
        **kwargs: Any,
        ...
        await run_manager.on_tool_end(
            output, color=color, name=self.name, **kwargs
        )
        return output
...
def get_all_basemodel_annotations(
    ...
    if not (isinstance(cls, type) and is_pydantic_v2_subclass(cls)):
        ...
        for parent in orig_bases:
            ...
            generic_type_vars: tuple = getattr(
...
def _replace_type_vars(
    ...
    if isinstance(type_, TypeVar):
        ...
        new_args = tuple(
            _replace_type_vars(arg, generic_map, default_to_bound)
            for arg in args
        )
