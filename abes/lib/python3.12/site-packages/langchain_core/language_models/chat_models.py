...
class BaseChatModel(BaseLanguageModel[BaseMessage], ABC):
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        if not self._should_stream(
            async_api=False, **{**kwargs, 'stream': True}
        ):
            ...
            try:
                for chunk in self._stream(messages, stop=stop, **kwargs):
                    ...
                    chunk.message.response_metadata = (
                        _gen_info_and_msg_metadata(chunk)
                    )
    ...
    async def astream(
        ...
        **kwargs: Any,
        ...
        if not self._should_stream(
            async_api=True, **{**kwargs, 'stream': True}
        ):
    ...
    def _get_ls_params(
        ...
        **kwargs: Any,
        ...
        ls_params = LangSmithParams(
            ls_provider=default_provider, ls_model_type='chat'
        )
        if stop:
        ...
        **kwargs: Any,
        ...
        if self._should_stream(
            ...
            **kwargs,
            ...
            if inspect.signature(self._agenerate).parameters.get(
                'run_manager'
            ):
    ...
    def bind_tools(
        ...
        tools: Sequence[
            Union[
                typing.Dict[str, Any], type, Callable, BaseTool
            ]  # noqa: UP006
        ],
        **kwargs: Any,
    ...
    def with_structured_output(
        ...
        **kwargs: Any,
        ...
        LanguageModelInput, Union[typing.Dict, BaseModel]
    ]:  # noqa: UP006
