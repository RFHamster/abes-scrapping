...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    def __init__(
        ...
        *,
        ...
        output_messages_key: Optional[str] = None,
        history_messages_key: Optional[str] = None,
        history_factory_config: Optional[
        ...
        **kwargs: Any,
        ...
        runnable_sync: Runnable = runnable.with_listeners(
            on_end=self._exit_history
        )
        runnable_async: Runnable = runnable.with_alisteners(
            on_end=self._aexit_history
        )
    ...
    def _enter_history(
        ...
        hist: BaseChatMessageHistory = config['configurable'][
            'message_history'
        ]
        ...
        if not self.history_messages_key:
            ...
            input_val = (
                input
                if not self.input_messages_key
                else input[self.input_messages_key]
            )
    ...
    def _exit_history(self, run: Run, config: RunnableConfig) -> None:
        ...
        if not self.history_messages_key:
            historic_messages = config['configurable'][
                'message_history'
            ].messages
