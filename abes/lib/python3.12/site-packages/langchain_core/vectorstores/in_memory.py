...
class InMemoryVectorStore(VectorStore):
    ...
    def delete(
        self, ids: Optional[Sequence[str]] = None, **kwargs: Any
    ) -> None:
        if ids:
            for _id in ids:
    ...
    def similarity_search(
        ...
        return [
            doc
            for doc, _ in self.similarity_search_with_score(query, k, **kwargs)
        ]
    ...
    async def asimilarity_search(
        ...
        return [
            doc
            for doc, _ in await self.asimilarity_search_with_score(
                query, k, **kwargs
            )
        ]
