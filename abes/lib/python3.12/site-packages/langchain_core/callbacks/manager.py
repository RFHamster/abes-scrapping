    ...
    def merge(
        ...
        manager = self.__class__(
            ...
            inheritable_tags=list(
                set(self.inheritable_tags + other.inheritable_tags)
            ),
            metadata={
                **self.metadata,
                **other.metadata,
        ...
        inheritable_handlers = (
            self.inheritable_handlers + other.inheritable_handlers
        )
...
class AsyncCallbackManager(BaseCallbackManager):
    ...
    async def on_llm_start(
        ...
        **kwargs: Any,
        ...
        non_inline_tasks = []
        inline_handlers = [
            handler for handler in self.handlers if handler.run_inline
        ]
        non_inline_handlers = [
...
def _configure(
    ...
    if inheritable_callbacks or local_callbacks:
        if (
            isinstance(inheritable_callbacks, list)
    ...
    v1_tracing_enabled_ = env_var_is_set(
        'LANGCHAIN_TRACING'
