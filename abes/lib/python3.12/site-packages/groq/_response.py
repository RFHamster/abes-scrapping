...
_AsyncAPIResponseT = TypeVar(
    '_AsyncAPIResponseT', bound='AsyncAPIResponse[Any]'
)
...
class BaseAPIResponse(Generic[R]):
    ...
    def _parse(self, *, to: type[_T] | None = None) -> R | _T:
        ...
        if (
            ...
            raise TypeError(
                'Pydantic models must subclass our base model type, e.g. `from groq import BaseModel`'
            )
    ...
    def wrapped(
        *args: P.args, **kwargs: P.kwargs
        ...
        return ResponseContextManager(
            cast(Callable[[], APIResponse[R]], make_request)
        )
...
def to_custom_streamed_response_wrapper(
    ...
    def wrapped(
        *args: P.args, **kwargs: P.kwargs
        ...
        return ResponseContextManager(
            cast(Callable[[], _APIResponseT], make_request)
        )
...
def extract_response_type(typ: type[BaseAPIResponse[Any]]) -> type:
    ...
    return extract_type_var_from_base(
        ...
        generic_bases=cast(
            'tuple[type, ...]',
            (BaseAPIResponse, APIResponse, AsyncAPIResponse),
        ),
        index=0,
    )
