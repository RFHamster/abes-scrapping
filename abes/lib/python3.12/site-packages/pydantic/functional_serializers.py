...
class PlainSerializer:
    ...
    def __get_pydantic_core_schema__(
        ...
        schema[
            ...
            function=self.func,
            info_arg=_decorators.inspect_annotated_serializer(
                self.func, 'plain'
            ),
...
if TYPE_CHECKING:
    ...
    _FieldWrapSerializerT = TypeVar(
        '_FieldWrapSerializerT', bound=FieldWrapSerializer
    )
...
if TYPE_CHECKING:
    ...
    _ModelWrapSerializerT = TypeVar(
        '_ModelWrapSerializerT', bound=ModelWrapSerializer
    )
