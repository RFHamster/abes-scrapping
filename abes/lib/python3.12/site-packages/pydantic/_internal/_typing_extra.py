...
NONE_TYPES: tuple[Any, ...] = (
    None,
    NoneType,
    *(tp[None] for tp in LITERAL_TYPES),
)
...
def _check_classvar(v: type[Any] | None) -> bool:
    return (
        v is not None
        and v.__class__ is typing.ClassVar.__class__
...
def is_classvar(ann_type: type[Any]) -> bool:
    ...
    if ann_type.__class__ == typing.ForwardRef and classvar_re.match(
...
def get_cls_type_hints_lenient(
    ...
    mro: Iterable[type[Any]] | None = None,
) -> dict[str, Any]:
...
def _eval_type_backport(
    ...
    try:
        ...
        if not (
            isinstance(value, typing.ForwardRef)
            and is_backport_fixable_error(e)
        ):
            raise
