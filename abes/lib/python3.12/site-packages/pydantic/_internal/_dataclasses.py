    ...
    *,
    ...
    try:
        if get_core_schema:
            ...
            schema = gen_schema.generate_schema(
                cls, from_dunder_get_core_schema=False
            )
    ...
    if config_wrapper.validate_assignment:
        ...
        def validated_setattr(
            instance: Any, field: str, value: str, /
        ) -> None:
...
def is_builtin_dataclass(
    _cls: type[Any],
) -> TypeGuard[type[StandardDataclass]]:
