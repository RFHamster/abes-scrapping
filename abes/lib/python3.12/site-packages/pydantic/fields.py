...
class _FromFieldInfoInputs(typing_extensions.TypedDict, total=False):
    ...
    title: str | None
    field_title_generator: typing_extensions.Callable[
        [str, FieldInfo], str
    ] | None
...
class FieldInfo(_repr.Representation):
    ...
    metadata_lookup: ClassVar[
        dict[str, typing.Callable[[Any], Any] | None]
    ] = {
        'strict': types.Strict,
        ...
        *field_infos: FieldInfo, **overrides: Any
        ...
        for field_info in field_infos:
            ...
            try:
                ...
                if isinstance(existing_json_schema_extra, dict) and isinstance(
    ...
    def _collect_metadata(kwargs: dict[str, Any]) -> list[Any]:
        ...
        if general_metadata:
            metadata.append(
                _fields.pydantic_general_metadata(**general_metadata)
            )
        return metadata
    ...
    def apply_typevars_map(
        ...
        annotation = _typing_extra.eval_type_lenient(
            self.annotation, types_namespace
        )
        self.annotation = _generics.replace_types(annotation, typevars_map)

    def __repr_args__(self) -> ReprArgs:
        yield 'annotation', _repr.PlainRepr(
            _repr.display_as_type(self.annotation)
        )
        ...
        for s in self.__slots__:
            ...
            if s == 'validation_alias' and self.validation_alias == self.alias:
                continue
            if (
                s == 'serialization_alias'
                and self.serialization_alias == self.alias
            ):
                continue
...
class ComputedFieldInfo:
    ...
    alias_priority: int | None
    title: str | None
    field_title_generator: typing.Callable[
