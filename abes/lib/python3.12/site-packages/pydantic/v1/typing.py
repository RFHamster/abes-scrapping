...
if sys.version_info < (3, 8):
    ...
    def get_origin(tp: Type[Any]) -> Optional[Type[Any]]:
        ...
        if type(tp).__name__ in AnnotatedTypeNames:
            return cast(
                Type[Any], Annotated
            )  # mypy complains about _SpecialForm
...
def _check_classvar(v: Optional[Type[Any]]) -> bool:
    ...
    return (
        v.__class__ == ClassVar.__class__
...
def update_field_forward_refs(
    field: 'ModelField', globalns: Any, localns: Any
) -> None:
    """
    ...
    if field.type_.__class__ == ForwardRef:
        prepare = True
        field.type_ = evaluate_forwardref(
            field.type_, globalns, localns or None
        )
