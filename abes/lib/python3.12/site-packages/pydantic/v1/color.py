...
class RGBA:
    ...
    def __init__(self, r: float, g: float, b: float, alpha: Optional[float]):
        ...
        self._tuple: Tuple[float, float, float, Optional[float]] = (
            r,
            g,
            b,
            alpha,
...
class Color(Representation):
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            ...
            and self.as_rgb_tuple() == other.as_rgb_tuple()
        )
...
def parse_color_value(value: Union[int, str], max_val: int = 255) -> float:
    ...
    if 0 <= color <= max_val:
        ...
        raise ColorError(
            reason=f'color values must be in the range 0 to {max_val}'
        )
...
def parse_hsl(
    ...
    """
    s_value, l_value = parse_color_value(sat, 100), parse_color_value(
        light, 100
    )
