...
class ValidatedFunction:
    ...
    def create_model(
        ...
        if hasattr(CustomConfig, 'fields') or hasattr(
        ...
        class DecoratorBaseModel(BaseModel):
            ...
            @validator(
                self.v_kwargs_name, check_fields=False, allow_reuse=True
            )
            def check_kwargs(
            ...
            @validator(
                V_POSITIONAL_ONLY_NAME, check_fields=False, allow_reuse=True
            )
            ...
            @validator(
                V_DUPLICATE_KWARGS, check_fields=False, allow_reuse=True
            )
            def check_duplicate_kwargs(cls, v: Optional[List[str]]) -> None:
                ...
                keys = ', '.join(map(repr, v))
                raise TypeError(
                    f'multiple values for argument{plural}: {keys}'
                )
